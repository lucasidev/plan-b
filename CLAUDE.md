...
8. [`docs/design/design-system.md`](docs/design/design-system.md). Contrato visual del producto (paleta, tipografía, tokens y su mapping al frontend). Antes de tocar visuales, chequear acá. Qué vistas existen y qué muestra cada una lo dice el mapa de producto ([`docs/design/map/`](docs/design/map/README.md), mid-fi, portado a [`docs/domain/product-map.md`](docs/domain/product-map.md)); las capturas del canvas de la versión anterior están congeladas como historia.
