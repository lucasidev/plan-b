...
6. [`docs/engineering/rollback.md`](docs/engineering/rollback.md). Qué hacer cuando algo entra a main y rompe. Política "revert first, investigate after" + comandos exactos para code, DB schema y tags narrativos. Y [`docs/engineering/runbook.md`](docs/engineering/runbook.md): qué hacer cuando el stage se rompe (cada caso con síntoma, diagnóstico y acción) y el inventario de secretos.
