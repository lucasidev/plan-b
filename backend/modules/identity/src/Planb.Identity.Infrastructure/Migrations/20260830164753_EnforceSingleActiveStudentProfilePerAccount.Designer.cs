...
namespace Planb.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260830164753_EnforceSingleActiveStudentProfilePerAccount")]
    partial class EnforceSingleActiveStudentProfilePerAccount
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Planb.Identity.Domain.Users.User", b =>
                {
                    ...
                    b.Property<Guid?>("PendingCareerId")
                        .HasColumnType("uuid")
                        .HasColumnName("pending_career_id");

                    b.Property<Guid?>("PendingCareerPlanId")
                        .HasColumnType("uuid")
