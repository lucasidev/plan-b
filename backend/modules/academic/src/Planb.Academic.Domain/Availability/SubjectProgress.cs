...
///
/// <para>
/// Es un tipo propio y no el enum de Enrollments a propósito: Academic no referencia el dominio de
/// otros módulos (ADR-0017), y acá solo importa lo que cambia la decisión de "puedo cursar esto",
/// no todos los matices del historial. La traducción desde <c>EnrollmentStatus</c> la hace el read
/// model del consumidor.
/// </para>
/// </summary>
