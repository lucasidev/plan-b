...
/// <summary>
/// Autorización compartida por los endpoints de gestión de correlativas (admin CRUD, US-062). El
/// rol se gatea a nivel HTTP con RequireRole: el JwtIssuer del backend emite el claim de rol
...
/// que el string siga matcheando el claim real. Mismo patrón que <c>AdminAcademicTermPolicy</c>.
/// </para>
/// </summary>
internal static class AdminPrerequisitePolicy
{
