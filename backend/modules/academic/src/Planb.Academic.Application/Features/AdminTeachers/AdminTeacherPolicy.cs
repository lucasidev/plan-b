...
/// <summary>
/// Autorización compartida por los endpoints de gestión de docentes (admin CRUD, US-063). El rol se
/// gatea a nivel HTTP con RequireRole: el JwtIssuer del backend emite el claim de rol
...
/// </para>
/// </summary>
internal static class AdminTeacherPolicy
{
