...
/// sigla de la institución que la dicta, que es lo que distingue la misma carrera ofrecida en
/// instituciones distintas; para institución, Label = su nombre y Sublabel vacío. El front deriva
/// el href del par (type, id), así el backend no conoce rutas de frontend.
/// </summary>
