...
/// <summary>
/// Autorización compartida por los endpoints de gestión de planes de estudio (admin CRUD, US-061).
...
/// que el string siga matcheando el claim real.
/// </para>
/// </summary>
internal static class AdminCareerPlanPolicy
{
