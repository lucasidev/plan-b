...
/// <summary>
/// Autorización compartida por los endpoints de gestión de períodos lectivos (admin CRUD, US-064).
/// El rol se gatea a nivel HTTP con RequireRole: el JwtIssuer del backend emite el claim de rol
...
/// que el string siga matcheando el claim real. Mismo patrón que <c>AdminCareerPolicy</c>.
/// </para>
/// </summary>
internal static class AdminAcademicTermPolicy
{
