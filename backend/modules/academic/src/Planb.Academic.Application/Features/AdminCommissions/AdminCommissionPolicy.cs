...
/// <summary>
/// Autorización compartida por los endpoints de gestión de comisiones (admin CRUD, US-093). El rol
...
/// que el string siga matcheando el claim real. Mismo patrón que AdminSubjectPolicy.
/// </para>
/// </summary>
internal static class AdminCommissionPolicy
{
