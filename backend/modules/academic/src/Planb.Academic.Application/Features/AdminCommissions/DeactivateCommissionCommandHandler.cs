...
/// <summary>
/// Handler del POST /api/academic/commissions/{id}/deactivate (admin). Soft delete vía
/// <see cref="Commission.Deactivate"/>. 404 si no existe; 409 si ya estaba inactiva (idempotencia
/// explícita del aggregate).
/// </summary>
public static class DeactivateCommissionCommandHandler
{
    public static async Task<Result<CommissionStatusResponse>> Handle(
        DeactivateCommissionCommand command,
