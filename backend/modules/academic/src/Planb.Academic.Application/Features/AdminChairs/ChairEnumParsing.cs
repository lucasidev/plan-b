...
/// <summary>
/// Parseo del rol que viaja como string en los requests de cátedra (US-196). El enum no se bindea
/// directo desde JSON, así que un typo del admin tiene que salir como 400 con su mensaje y no como
