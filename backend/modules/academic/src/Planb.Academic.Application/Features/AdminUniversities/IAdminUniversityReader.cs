...
/// catálogo público (<c>IAcademicQueryService.ListUniversitiesAsync</c>, que solo devuelve activas
/// con un shape mínimo id/name/slug), este trae activas e inactivas con su estado + count
