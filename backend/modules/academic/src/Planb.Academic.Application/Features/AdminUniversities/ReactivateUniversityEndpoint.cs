...
/// <summary>
/// POST /api/academic/universities/{id}/reactivate (admin, US-060). Revierte el soft delete.
/// Gateado a rol Admin.
/// </summary>
public sealed class ReactivateUniversityEndpoint : ICarterModule
{
    public void AddRoutes(IEndpointRouteBuilder app)
    {
        app.MapPost("/api/academic/universities/{id:guid}/reactivate", async (
            Guid id,
            IMessageBus bus,
            CancellationToken ct) =>
        {
            ...
            var result = await bus.InvokeAsync<Result<UniversityStatusResponse>>(
                new ReactivateUniversityCommand(id), ct);
            if (result.IsSuccess)
            {
        ...
        .WithName("Academic_ReactivateUniversity")
        .WithTags("Academic")
