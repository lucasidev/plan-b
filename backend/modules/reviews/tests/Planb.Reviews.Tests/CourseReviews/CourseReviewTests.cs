...
/// <summary>
/// Domain unit tests de <see cref="CourseReview"/> (US-146, ADR-0082): creación, revisión, borrado
...
public class CourseReviewTests
{
    ...
    private static Result<CourseReview> Create(
        Guid? accountId = null,
        Guid? subjectId = null,
        Guid? termId = null,
        Guid? chairId = null,
    ...
    private static CourseReview CreatedReview(
        Guid? accountId = null,
        IEnumerable<(ItemId ItemId, short OptionValue)>? answers = null,
        string? freeText = null,
        DateTimeOffset? at = null) =>
    ...
    public void Create_NoAnswers_ReturnsNoAnswersError()
    {
        ...
        result.Error.ShouldBe(CourseReviewErrors.NoAnswers);
    }
    ...
    public void Create_DuplicateAnswer_ReturnsDuplicateAnswerError()
    {
        ...
        result.IsFailure.ShouldBeTrue();
        result.Error.ShouldBe(CourseReviewErrors.DuplicateAnswer);
    }
    ...
    public void Create_ItemNotInInstrument_ReturnsItemNotInInstrumentError()
    {
        ...
        result.IsFailure.ShouldBeTrue();
        result.Error.ShouldBe(CourseReviewErrors.ItemNotInInstrument);
    }
    ...
    public void Create_OptionNotInItem_ReturnsOptionNotInItemError()
    {
        ...
        result.IsFailure.ShouldBeTrue();
        result.Error.ShouldBe(CourseReviewErrors.OptionNotInItem);
    }

    [Fact]
    public void Create_FreeTextTooLong_ReturnsFreeTextTooLongError()
    {
        var tooLong = new string('a', CourseReview.MaxFreeTextLength + 1);

        var result = Create(freeText: tooLong);

        result.IsFailure.ShouldBeTrue();
        result.Error.ShouldBe(CourseReviewErrors.FreeTextTooLong);
    }
    ...
    public void Hydrate_ValidAnswers_ReconstitutesWithItsAnswers()
    {
        ...
        var review = CourseReview.Hydrate(
            id,
            accountId,
            subjectId,
            termId,
    ...
    {
        Should.Throw<ArgumentException>(() => CourseReview.Hydrate(
            CourseReviewId.New(),
            Guid.NewGuid(),
            Guid.NewGuid(),
            Guid.NewGuid(),
