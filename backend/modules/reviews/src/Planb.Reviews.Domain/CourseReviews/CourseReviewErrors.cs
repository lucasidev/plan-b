...
/// <summary>Errores de negocio del aggregate <see cref="CourseReview"/> (US-146, ADR-0082).</summary>
public static class CourseReviewErrors
{
    public static readonly Error NotFound =
        Error.NotFound("reviews.course_review.not_found", "Review not found.");
    ...
    public static readonly Error AlreadyReviewed =
        Error.Conflict(
            "reviews.course_review.already_reviewed",
    ...
    public static readonly Error ItemNotInInstrument =
        Error.Validation(
            "reviews.course_review.item_not_in_instrument",
    ...
    public static readonly Error OptionNotInItem =
        Error.Validation(
            "reviews.course_review.option_not_in_item",
            "That option does not belong to the answered item.");

    public static readonly Error FreeTextTooLong =
        Error.Validation(
            "reviews.course_review.free_text_too_long",
            $"The free text must be at most {CourseReview.MaxFreeTextLength} characters.");
    ...
    public static readonly Error SubjectNotFound =
        Error.NotFound(
            "reviews.course_review.subject_not_found",
    ...
    public static readonly Error TermNotFound =
        Error.NotFound(
            "reviews.course_review.term_not_found",
    ...
    public static readonly Error ChairNotInSubject =
        Error.Validation(
            "reviews.course_review.chair_not_in_subject",
    ...
    public static readonly Error NoCurrentInstrument =
        Error.Conflict(
            "reviews.course_review.no_current_instrument",
    ...
    public static readonly Error NotTheAuthor =
        Error.Forbidden(
            "reviews.course_review.not_the_author",
