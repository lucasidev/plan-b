...
/// </para>
/// </summary>
public sealed class CourseReview : Entity<CourseReviewId>, IAggregateRoot
{
    ...
    public static CourseReview Hydrate(
        CourseReviewId id,
        Guid accountId,
        Guid subjectId,
        Guid termId,
        ...
        IReadOnlyDictionary<ItemId, IReadOnlySet<short>> allowedOptionsByItem)
    {
        ...
        foreach (var (itemId, optionValue) in answers)
        {
            ...
            {
                return CourseReviewErrors.DuplicateAnswer;
            }
            ...
            {
                return CourseReviewErrors.OptionNotInItem;
            }
        ...
        if (result.Count == 0)
        {
            return CourseReviewErrors.NoAnswers;
        }
    ...
    private static Result ValidateFreeText(string? freeText)
    {
        ...
        {
            return CourseReviewErrors.FreeTextTooLong;
        }
        return Result.Success();
    }
