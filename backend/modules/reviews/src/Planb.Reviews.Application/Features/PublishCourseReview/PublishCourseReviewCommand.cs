...
/// </para>
/// </summary>
public sealed record PublishCourseReviewCommand(
    Guid UserId,
    Guid SubjectId,
    Guid TermId,
    Guid? ChairId,
    IReadOnlyList<CourseReviewAnswerInput> Answers,
    string? FreeText);

/// <summary>Una respuesta: el código del ítem y el valor de la opción elegida.</summary>
public sealed record CourseReviewAnswerInput(string ItemCode, short OptionValue);
