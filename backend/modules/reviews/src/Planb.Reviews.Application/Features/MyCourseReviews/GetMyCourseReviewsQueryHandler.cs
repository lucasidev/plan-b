...
///
/// <para>
/// Las reseñas salen de <see cref="IMyCourseReviewsQueryService"/>, que no sale del schema
...
/// </para>
/// </summary>
public static class GetMyCourseReviewsQueryHandler
{
    ...
    public static async Task<IReadOnlyList<MyCourseReviewView>> Handle(
        Guid accountId,
