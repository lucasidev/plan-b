...
/// </para>
/// </summary>
public static class ReviseCourseReviewCommandHandler
{
    public static async Task<Result<ReviseCourseReviewResponse>> Handle(
        ReviseCourseReviewCommand command,
        ...
        CancellationToken ct)
    {
        ...
        return new ReviseCourseReviewResponse(review.Id.Value, review.Answers.Count);
    }
}
