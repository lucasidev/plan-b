...
/// podía editarla (ver la revisión 2026-07-29 de ADR-0063). La salida que se construyó es que
...
///
/// <para>
/// El diseño de ADR-0063 dice que el embedding se encola recién cuando un moderator la mueva a
