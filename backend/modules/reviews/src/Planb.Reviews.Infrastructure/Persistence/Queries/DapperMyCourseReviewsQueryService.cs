...
/// pide <c>GetMyCourseReviewsQueryHandler</c> al contrato de academic, en una sola llamada con
...
internal sealed class DapperMyCourseReviewsQueryService : IMyCourseReviewsQueryService
{
    ...
    public DapperMyCourseReviewsQueryService(IDbConnectionFactory connections) =>
        _connections = connections;

    public async Task<IReadOnlyList<MyCourseReviewRow>> ListAsync(
        Guid accountId, CancellationToken ct = default)
    {
        ...
        return rows
            .Select(r => new MyCourseReviewRow(
                r.Id,
                r.SubjectId,
                r.TermId,
                r.ChairId,
