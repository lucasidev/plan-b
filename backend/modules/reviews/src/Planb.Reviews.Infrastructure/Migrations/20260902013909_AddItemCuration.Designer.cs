...
namespace Planb.Reviews.Infrastructure.Migrations
{
    ...
    [Migration("20260902013909_AddItemCuration")]
    partial class AddItemCuration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Planb.Reviews.Domain.Catalog.Item", b =>
                {
                    ...
                    b.Property<Guid?>("SupersedesItemId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("SupersedesItemId")
                        .HasDatabaseName("ix_items_supersedes_item_id");

                    b.ToTable("items", "reviews");
                });

            modelBuilder.Entity("Planb.Reviews.Domain.Curation.EditorialNote", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("CareerId", "WithdrawnAt")
                        .HasDatabaseName("ix_editorial_notes_career");

                    b.ToTable("editorial_notes", "reviews");
                });
            ...
            modelBuilder.Entity("Planb.Reviews.Domain.Catalog.Item", b =>
                {
                    b.HasOne("Planb.Reviews.Domain.Catalog.Item", null)
                        .WithMany()
                        .HasForeignKey("SupersedesItemId")
