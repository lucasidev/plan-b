...
public class EveryWriteEndpointIsDeclaredTests : IClassFixture<RegisterApiFixture>
{
    ...
    [Fact]
    public void The_catalogue_covers_exactly_the_53_write_endpoints_of_the_spec()
    {
        ...
        // US-236 agrega suspensión y reactivación de cuentas de alumnos.
        RealWriteEndpoints().Count.ShouldBe(53);
        WriteEndpoints.All.Count.ShouldBe(53);
    }
