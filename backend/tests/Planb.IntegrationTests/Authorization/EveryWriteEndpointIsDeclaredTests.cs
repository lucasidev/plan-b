...
public class EveryWriteEndpointIsDeclaredTests : IClassFixture<RegisterApiFixture>
{
    ...
    [Fact]
    public void The_catalogue_covers_exactly_the_58_write_endpoints_of_the_spec()
    {
        ...
        // US-236 suma dos operaciones de acceso y US-234 suma cinco escrituras institucionales.
        RealWriteEndpoints().Count.ShouldBe(58);
        WriteEndpoints.All.Count.ShouldBe(58);
    }
