...
/// </para>
/// </summary>
public class MyReviewsEndpointTests : IClassFixture<RegisterApiFixture>
{
    ...
    public MyReviewsEndpointTests(RegisterApiFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task Deleting_takes_the_review_out_of_the_counts()
    {
        ...
        var again = await auth.Client.DeleteAsync($"/api/reviews/courses/{id}");
    ...
    public async Task Someone_elses_review_answers_404_and_never_403()
    {
        ...
        var deleted = await stranger.Client.DeleteAsync($"/api/reviews/courses/{id}");
    ...
    public async Task Reading_my_reviews_without_a_session_is_unauthorized()
    {
        ...
        var response = await anonymous.GetAsync("/api/reviews/courses/me");
