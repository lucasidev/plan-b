 ...
 * enseñan la finalización y las dos primeras preguntas **en el orden de la ficha**, que es alfabético
 * por código de pregunta: elegir "los peores" convertiría la muestra en una acusación y elegir "los
