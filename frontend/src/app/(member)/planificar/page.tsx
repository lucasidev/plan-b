...
import { MOCK_ACTIVE_SIMULATION, MOCK_DRAFTS, PlanificarShell } from '@/features/planificar';
...
/**
 * /planificar (US-046). Maqueta del shell de Planificar con tabs (en-curso / borrador), mock
