 ...
 *   - Que saltear sea real: se contestan tres de las catorce preguntas y la reseña se publica igual.
...
test.describe('Reseñar una cursada (US-146)', () => {
  ...
  test('publica una reseña con lo que se contestó, y saltear no cuenta', async ({
    ...
    // Pasos 3 a 5: se contestan TRES preguntas de las catorce que ofrece el cuestionario. El resto
