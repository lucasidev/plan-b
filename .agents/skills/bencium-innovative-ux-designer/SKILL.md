...
description: >
  Alternativa estilizada y experimental (sombras, gradientes, tipografía expresiva) para campañas y piezas de vitrina. NO se dispara sola en planb: el default de UX/UI es bencium-controlled-ux-designer. Usar solo cuando Lucas lo pida por nombre o para la landing pública, nunca para pantallas de producto (fichas, formularios, backoffice).
metadata:
  version: 2.0.0
---
...
- **Frontend Aesthetics Cookbook (fuente original)**: https://github.com/anthropics/claude-cookbooks/blob/main/coding/prompting_for_frontend_aesthetics.ipynb
