...
description: >
  Alternativa anti-slop (adaptación de frontend-design) para cuando una pantalla salió genérica y hay que darle carácter. NO se dispara sola en planb: el default de UX/UI es bencium-controlled-ux-designer. Usar solo cuando Lucas lo pida por nombre.
metadata:
  version: 1.2.0
---
...
Fuente original: [frontend-design](https://github.com/anthropics/claude-code/blob/main/plugins/frontend-design/skills/frontend-design/SKILL.md).
