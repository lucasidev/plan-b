...
**Para correcciones masivas**, usá la herramienta de edición disponible para reemplazar mecánicamente cada apóstrofo recto por el carácter UTF-8 real `’` (U+2019), no por una secuencia de escape.
