...
docs/product/design-system.md UPDATES REQUIRED

- [New tokens, colors, spacing values, typography changes, or component additions needed]
- These must be approved and added to docs/product/design-system.md before implementation begins
...
GOOD: "CardComponent border-radius: 8px → 12px per updated docs/product/design-system.md token border-radius-lg"

BAD:  "Improve the spacing"
GOOD: "DashboardHeader margin-bottom: 16px → 24px (docs/product/design-system.md spacing-lg)"

BAD:  "The button needs more contrast"
GOOD: "PrimaryButton background: #6B7280 → #2563EB (docs/product/design-system.md color-brand-primary).
...
3. If a new token is needed, it goes in docs/product/design-system.md UPDATES first
