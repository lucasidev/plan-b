...
|---|---|---|---|
| D01 | **Qué recaba "marcar el plan"** (O3-2, `micarrera`): el filtro "lo que todavía puedo cursar" necesita saber qué aprobaste en todo el plan, y la tesis no lo pide. | Permitir el hecho suelto "la cursé, cómo terminó" desde la pantalla del plan, de a uno y sin frases: es el mismo hecho de trayectoria de 0067, sin inventario obligatorio; cuenta para aprobación y abandono por materia, no como voz de frases. La alternativa es cancelar O3-2. | Pendiente |
