...
- Mockup: ![Ingresar](../../history/design-v1/reference/screenshots/auth-login.png). Fuente JSX en `canvas-mocks/auth.jsx::LoginView` (con `LastActivityPanel` en el panel izquierdo).
