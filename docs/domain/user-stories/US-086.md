...
> El backoffice no tiene namespace propio: cada feature admin vive en la API de su módulo. Ver [ADR-0050](../../decisions/0050-backoffice-como-corte-transversal.md). `User` es agregado del módulo **identity**: la ruta va ahí (el read model sigue siendo cross-schema vía Dapper por dentro).
...
- **Depende de**: [ADR-0042](../../decisions/0042-audit-log-per-bc-no-central.md), [ADR-0031](../../decisions/0031-review-audit-log-como-projection.md), [US-058](US-058.md) (detalle de usuario donde se monta el tab), [US-081](US-081.md) (admin shell + tabs).
...
- Mockup admin canvas (sección ③):
  - ![Usuario · detalle con tab Audit log](../../history/design-v1/reference/screenshots/admin-mod-adm-usr-det.png)
