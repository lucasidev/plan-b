...
**Priority**: Medium
**Effort**: S
**UC**: [UC-063](../../history/domain-v1/use-cases/UC-063.md)
**ADR refs**: ninguno.
...
- Use Case: [UC-063](../../history/domain-v1/use-cases/UC-063.md)
- Mockups admin canvas (sección ① + ②):
  - ![Wizard step 4 · Catálogo inicial](../../history/design-v1/reference/screenshots/admin-onb-adm-onb-4.png)
  - ![Docentes · listado con flags de calidad](../../history/design-v1/reference/screenshots/admin-datos-adm-doc-list.png)
