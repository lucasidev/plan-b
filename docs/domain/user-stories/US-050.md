...
**Priority**: High
**Effort**: M
**UC**: [UC-050](../../history/domain-v1/use-cases/UC-050.md)
...
- Use Case: [UC-050](../../history/domain-v1/use-cases/UC-050.md)
- Mockup admin canvas (sección ③):
  - ![Reportes · cola](../../history/design-v1/reference/screenshots/admin-mod-adm-rep-list.png)
