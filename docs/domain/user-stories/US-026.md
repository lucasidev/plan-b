...
- Use Case: ninguno.
- Mockup: ![Descartar borrador](../../history/design-v1/reference/screenshots/sim-v2-modal-descartar.png). Fuente JSX en `canvas-mocks/v2-modals.jsx::V2ModalDescartarBorrador`.
