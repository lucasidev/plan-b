...
**Sprint**: S10
**Epic**: [EPIC-00: Foundations & DevEx](../../history/domain-v1/epics/EPIC-00.md) (estado transversal del producto)
**Priority**: Medium
**Effort**: S
...
- Mockup: ![Inicio · sin conexión](../../history/design-v1/reference/screenshots/home-v2-inicio-offline.png). Fuente JSX en `canvas-mocks/v2-empty.jsx::V2OfflineBanner`.
