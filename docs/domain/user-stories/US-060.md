...
**Priority**: High
**Effort**: M
**UC**: [UC-060](../../history/domain-v1/use-cases/UC-060.md)
**ADR refs**: ADR-0001
...
- Use Case: [UC-060](../../history/domain-v1/use-cases/UC-060.md)
- Mockups admin canvas (sección ① + ②):
  - ![Wizard step 1 · Universidad](../../history/design-v1/reference/screenshots/admin-onb-adm-onb-1.png)
  - ![Wizard step 5 · Resumen](../../history/design-v1/reference/screenshots/admin-onb-adm-onb-5.png)
  - ![Universidades · listado](../../history/design-v1/reference/screenshots/admin-datos-adm-uni-list.png)
  - ![Universidad · detalle (UNSTA)](../../history/design-v1/reference/screenshots/admin-datos-adm-uni-det.png)
