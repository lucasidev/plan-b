...
**Status**: En curso
**Sprint**: MVP. El admin real aterrizó (cuentas staff US-067 + permisos US-068 + CRUD de docentes US-063, backend en este ciclo), así que el shell del admin deja de ser post-MVP: se construye ahora.
