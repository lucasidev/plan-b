...
**Priority**: High
**Effort**: S
**UC**: [UC-029](../../history/domain-v1/use-cases/UC-029.md)
...
- Use Case: [UC-029](../../history/domain-v1/use-cases/UC-029.md)
- Mockup (modal pendiente): ![Cerrar sesión](../../history/design-v1/reference/screenshots/cuenta-v2-modal-logout.png). Fuente JSX en `canvas-mocks/v2-modals.jsx::V2ModalCerrarSesion`.
