...
- Mockups (canvas v2):
  - ![Sign up](../../history/design-v1/reference/screenshots/auth-signup.png) (panel izq: `CarnetPreview`).
  - ![Sign up · email duplicado](../../history/design-v1/reference/screenshots/auth-signup-err.png) (banner inline `AuthErrorBanner`).
  - ![Sign in](../../history/design-v1/reference/screenshots/auth-login.png) (panel izq: `LastActivityPanel`).
  - ![Sign in · credenciales inválidas](../../history/design-v1/reference/screenshots/auth-login-err.png) (banner inline `AuthErrorBanner`).
  - ![Forgot password](../../history/design-v1/reference/screenshots/auth-forgot.png) (panel izq: `FlowSteps` paso 1).
  - ![Forgot link sent](../../history/design-v1/reference/screenshots/auth-forgot-ok.png) (panel izq: `FlowSteps` paso 2).
  - ![Onboarding · welcome](../../history/design-v1/reference/screenshots/onb-welcome.png).
  - ![Onboarding · career](../../history/design-v1/reference/screenshots/onb-career.png).
  - ![Onboarding · history](../../history/design-v1/reference/screenshots/onb-history.png).
  - ![Onboarding · done](../../history/design-v1/reference/screenshots/onb-done.png).
