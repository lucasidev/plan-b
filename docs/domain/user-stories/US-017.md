...
- [ ] Domain service `IReviewContentFilter` (impl básica: insultos, links sospechosos, longitudes anómalas)
- [ ] Endpoint Carter
...
- Mockup: `docs/design/reference/components/screens.jsx` (ver `WriteReviewView` para layout del form de publicación con selector de docente)
