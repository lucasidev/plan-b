...
**Priority**: High
**Effort**: M
**UC**: [UC-051](../../history/domain-v1/use-cases/UC-051.md)
...
- Use Case: [UC-051](../../history/domain-v1/use-cases/UC-051.md)
- Mockup admin canvas (sección ③):
  - ![Reporte · detalle con 5 opciones](../../history/design-v1/reference/screenshots/admin-mod-adm-rep-det.png)
