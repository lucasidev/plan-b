...
- Mockups (3 artboards de la sección ⑦ Reseñas del canvas, del shell con tabs):
  ...
  - Fuente JSX en `canvas-mocks/v2-screens-3.jsx::V2Resenas` (tabs `leer`, `escribir`, `mias`). El editor (`V2EditorResena`) es de US-017.
