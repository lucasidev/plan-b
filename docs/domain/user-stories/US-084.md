...
- Mockup: ![Migración de plan](../../history/design-v1/reference/screenshots/admin-ops-adm-mig.png). Fuente JSX en `canvas-mocks/admin-screens-3.jsx::AdmMigracionPlan`.
