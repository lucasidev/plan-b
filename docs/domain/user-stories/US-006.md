...
- Mockup: ![Merge de duplicados](../../history/design-v1/reference/screenshots/admin-datos-adm-mat-merge.png). Fuente JSX en `canvas-mocks/admin-screens-2.jsx::AdmMateriasMerge`.
