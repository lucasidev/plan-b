...
Vocabulario de la tesis vigente ([THESIS.md](../THESIS.md), sección "Qué recabamos"). Es lo que la persona hace y lo que el sistema recibe. Los términos de lo que se **publica** entran a medida que esa capa cierra (la proporción de voces, el encogimiento, los dos ejes, la atribución, la derivación, la cobertura, la trayectoria y las comparaciones, el testimonio): "qué publicamos" está cerrado entero.
...
| **Atribución** | De qué lado cae una frase: "la carrera siendo dura" (eje exigencia) o "alguien fallando" (eje gestión). **La decide el eje**, nunca el sujeto ni la persona ([ADR-0065](../decisions/0065-attribution-is-the-axis-not-a-split.md)). Se publica como dos proporciones de personas con el mismo denominador ("5 de cada 10 dicen que es dura; 7 de cada 10 marcaron alguien fallando"), **nunca como un split** ("el 65% de lo difícil"): ese número depende del catálogo, no de la gente. |
...
| **cohorte** | "La misma combinación de materias" (la acepción del planificador, en retiro) | En el producto nuevo es la camada de ingreso: las cuentas que entraron a una carrera en una institución el mismo año. |
