...
| **Pendiente de vincular** | La materia que alguien nombró al reseñar y el catálogo no tiene. La reseña se guarda; no cuenta en ninguna ficha ni en la cobertura hasta que el catálogo la vincula a la materia canónica (BO1-7); el autor la ve como pendiente en Mis aportes. |
