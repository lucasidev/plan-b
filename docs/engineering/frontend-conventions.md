...
Detalle que amplía [`frontend/AGENTS.md`](../../frontend/AGENTS.md); el contrato general está en [`AGENTS.md`](../../AGENTS.md) y las decisiones en [`../decisions/`](../decisions). Claude Code lo carga al tocar `frontend/` (lo importa `frontend/CLAUDE.md`); los demás clientes lo leen cuando lo necesitan.
...
Ver [ADR-0020](../decisions/0020-frontend-features-aligned-with-backend-modules.md).
...
```
Si alguien "arregla" un action agregándole `revalidatePath`, reintroduce el bug. Ver [ADR-0046](../decisions/0046-server-actions-as-pure-mutations.md).

Ver [ADR-0021](../decisions/0021-data-fetching-rsc-tanstack-query.md).
...
Ver [ADR-0022](../decisions/0022-forms-react19-primitives-tanstack-form.md).
...
Convenciones detalladas en [`docs/engineering/testing.md`](../engineering/testing.md). Resumen para frontend:
...
- **No** tocar `globals.css` para agregar clases arbitrarias. Usar Tailwind utilities o `@theme` si es variable de diseño. Tokens documentados en [`docs/product/design-system.md`](../product/design-system.md).
