...
| Artboard | Imagen | US |
|---|---|---|
| `ds-main` | `ds-ds-main.png` | [`docs/design/design-system.md`](../../../../design/design-system.md) (doc canónico transversal) |
...
| ③ Inicio | `v2-inicio-offline` | `home-v2-inicio-offline.png` | [US-039-f](../../../../domain/user-stories/US-039-f.md) (banner offline transversal) |
| ③ Inicio | `v2-err-404` | `home-v2-err-404.png` | [US-009-f](../../../../domain/user-stories/US-009-f.md) |
| ③ Inicio | `v2-err-5xx` | `home-v2-err-5xx.png` | [US-009-f](../../../../domain/user-stories/US-009-f.md) |
...
| ⑦ Rankings | `v2-rankings` | `rankings-v2-rankings.png` | [US-057](../../../../domain/user-stories/US-057.md) |
| ⑧ Búsqueda | `v2-buscar` | `busqueda-v2-buscar.png` | [US-056](../../../../domain/user-stories/US-056.md) |
| ⑧ Búsqueda | `v2-buscar-empty` | `busqueda-v2-buscar-empty.png` | [US-056](../../../../domain/user-stories/US-056.md) (AC sin resultados) |
...
| ① Afiliar uni | `adm-onb-3` | `admin-onb-adm-onb-3.png` | [US-061](../../../../domain/user-stories/US-061.md) + [US-007](../../../../domain/user-stories/US-007.md) (importador con preview/diff) |
...
| ② Datos académicos | `adm-imp` | `admin-datos-adm-imp.png` | [US-007](../../../../domain/user-stories/US-007.md) (importador CSV/preview, dim 1280×1000) |
| ② Datos académicos | `adm-mat-list` | `admin-datos-adm-mat-list.png` | [US-062](../../../../domain/user-stories/US-062.md) + [US-006](../../../../domain/user-stories/US-006.md) (flags + detección duplicados) |
| ② Datos académicos | `adm-mat-merge` | `admin-datos-adm-mat-merge.png` | [US-006](../../../../domain/user-stories/US-006.md) (merge de Subjects duplicados) |
...
| ③ Moderación | `adm-usr-list` | `admin-mod-adm-usr-list.png` | [US-058](../../../../domain/user-stories/US-058.md) (listado de usuarios con filter chips) |
| ③ Moderación | `adm-usr-det` | `admin-mod-adm-usr-det.png` | [US-058](../../../../domain/user-stories/US-058.md) + [US-086](../../../../domain/user-stories/US-086.md) (detalle + tabs Actividad/Reportes/Audit log) |
...
- **US nuevas creadas para la app del alumno**: [US-054-f](../../../../domain/user-stories/US-054-f.md), [US-055](../../../../domain/user-stories/US-055.md), [US-059-f](../../../../domain/user-stories/US-059-f.md), [US-039-f](../../../../domain/user-stories/US-039-f.md), [US-077-f](../../../../domain/user-stories/US-077-f.md), [US-077-b](../../../../domain/user-stories/US-077-b.md) + sub-slices [b-1](../../../../domain/user-stories/US-077-b-1.md) / [b-2](../../../../domain/user-stories/US-077-b-2.md) / [b-3](../../../../domain/user-stories/US-077-b-3.md), [US-009-f](../../../../domain/user-stories/US-009-f.md), [US-079-i](../../../../domain/user-stories/US-079-i.md), [US-085](../../../../domain/user-stories/US-085.md).
- **US nuevas creadas para el módulo admin**: [US-081](../../../../domain/user-stories/US-081.md), [US-007](../../../../domain/user-stories/US-007.md), [US-006](../../../../domain/user-stories/US-006.md), [US-084](../../../../domain/user-stories/US-084.md), [US-086](../../../../domain/user-stories/US-086.md), [US-005](../../../../domain/user-stories/US-005.md).
...
4. **Importador, merge de duplicados, migración de plan**: US separadas porque cada una es un sub-flujo pesado con UI propia. [US-007](../../../../domain/user-stories/US-007.md) (importador CSV con preview/diff), [US-006](../../../../domain/user-stories/US-006.md) (merge de Subjects), [US-084](../../../../domain/user-stories/US-084.md) (migración asistida cross-plan).
