...
No se editan. Los tokens siguen vigentes en `frontend/src/app/globals.css` y en [`design-system.md`](../../design/design-system.md); las pantallas nuevas se diseñan en [`docs/design/screens/`](../../design/screens/README.md). El pipeline de capturas se rehace cuando existan pantallas nuevas que capturar.
