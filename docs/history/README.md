...
Lo que sigue vivo de la versión anterior no está acá: las 126 fichas `US-NNN` siguen en `docs/plan/stories/` (son la evidencia del trabajo hecho y el mismo lugar donde entran las nuevas), la historia del diseño en [`docs/design/`](../product), y las decisiones en [`docs/decisions/`](../decisions) con su `Estado`.
