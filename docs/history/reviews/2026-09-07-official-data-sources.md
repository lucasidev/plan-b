...
| O03 | CONEAU no cubre pregrado: para una tecnicatura no hay acreditación, hay validez nacional (SIPES). El campo cambia de nombre con el nivel (F05). | Tesis línea 75 | Resuelto: `accreditation` y `national_validity` son campos separados del ADR-0090 (R6, tarea 4, [#484](https://github.com/lucasidev/plan-b/issues/484)) |
...
| O07 | SIPES y la Guía SIU son aplicaciones Toba con sesión y ventana emergente: automatizarlas es frágil (token por pedido, paginado por evento, ventana que carga por JavaScript), aunque las dos se leyeron enteras en este relevamiento. | Sofía, catálogo | Resuelto: la carga es a mano, por seed y backoffice, y no scrapea SIPES ni la Guía SIU (R6, tarea 3, [#483](https://github.com/lucasidev/plan-b/issues/483)) |
...
| O10 | El sitio de UTN Facultad Regional Tucumán no respondió durante todo el relevamiento y el de las ordenanzas del Consejo Superior rechazó la conexión: el "sitio institucional" como fuente tiene la fragilidad de cada sitio, y la ficha necesita decir la fecha en que se pudo leer. | ADR-0085 | Resuelto: `SourceRetrievedAt` es obligatorio en todo `OfficialFact`; el plan vigente de UTN-FRT queda cargado con la nota de que el Consejo Superior rechazó la conexión el 2026-09-07 (R6, tarea 3, [#483](https://github.com/lucasidev/plan-b/issues/483)) |
| O11 | Los anuarios 2020 y 2021 repiten para UNSTA los valores de 2019 (6393 estudiantes, 1877 nuevos inscriptos, 310 egresados): la institución no informó y la SPU arrastró el dato. Un proxy calculado sobre esas filas miente. | Método | Resuelto: el proxy de egreso de UNSTA se calcula sobre los nuevos inscriptos reales de 2019, no sobre la fila repetida de 2020 o 2021, con la nota dicha (R6, tarea 3, [#483](https://github.com/lucasidev/plan-b/issues/483)) |
