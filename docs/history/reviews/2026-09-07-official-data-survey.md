...
| K07 | San Pablo-T tiene filas en cero en los anuarios 2020 a 2022 y valores repetidos en 2016 y 2017: no informa a la SPU. Para esa institución, "cantidad de estudiantes" no es cero, es "no informado", y la cabecera de su ficha tiene que decirlo con la fecha. | SC-005, ADR-0090 | Pendiente: el estado "no publicado" cubre también el "no informado" |
