...
| K07 | San Pablo-T tiene filas en cero en los anuarios 2020 a 2022 y valores repetidos en 2016 y 2017: no informa a la SPU. Para esa institución, "cantidad de estudiantes" no es cero, es "no informado", y la cabecera de su ficha tiene que decirlo con la fecha. | SC-005, ADR-0090 | Resuelto: la afirmación `institution_type` de San Pablo-T queda `NotPublished`, citando K07, en vez de cero (R6, tarea 3, [#483](https://github.com/lucasidev/plan-b/issues/483)); la cabecera de identidad de SC-005 solo dibuja el bloque cuando hay afirmación relevada (R6, tarea 6, [#486](https://github.com/lucasidev/plan-b/issues/486)) |
