...
|---|---|---|---|
| V01 | La ficha de carrera no tiene datos oficiales (duración en el papel y en la realidad, egreso por cohorte) ni "qué frena"; lo declara con "Todavía no tenemos datos oficiales de esta carrera." No hay entidad ni tabla para eso. | US-127, US-133, US-129 | Resuelto en parte: la ficha de carrera dice "Dura en el papel", "Dura en la realidad" y "Egreso por cohorte" con fuente y período, y lo no publicado lo dice con fecha (R6, tarea 4, [#484](https://github.com/lucasidev/plan-b/issues/484); verificado en el [recorrido del 2026-09-13](2026-09-13-valentina-walk.md)); "qué frena la cursada" sigue sin construirse, no era parte de esa tarea |
| V02 | Dónde estudiarla no existe: ningún camino desde la carrera a la misma carrera en otras instituciones. | US-128 | Resuelto: "Comparar con otras instituciones" lleva a Dónde estudiarla, con UNT y San Pablo-T lado a lado y sin ganador (R6, tarea 5, [#485](https://github.com/lucasidev/plan-b/issues/485); verificado el 2026-09-13) |
| V03 | Explorar tiene una sola lente, por universidad, y `/careers` y `/subjects` responden 404. Valentina no tiene universidad: tiene, a lo sumo, una carrera. | US-222 | Resuelto: `/careers` y `/subjects` responden con el catálogo real, la segunda lente existe (R6, tarea 8, [#488](https://github.com/lucasidev/plan-b/issues/488); verificado el 2026-09-13) |
...
| V05 | Arriba de la ficha de Pérez no hay fama por convergencia aunque sus tres frases apuntan al mismo lado, y Método dice que "la ficha lo dice arriba, con las preguntas a la vista". No se sabe desde afuera si la regla pide más frases o si no está construido. | US-221, persona | Cerrado: la fama existe y la ficha la muestra arriba cuando converge, pero la regla pide más de la mitad estricta en al menos tres frases (`ChairFactsCalculator.BuildFame`) y Pérez tiene una en 57 % y dos justo en 50 %: no converge. Que ninguna cátedra del corpus la dispare es V16 del [recorrido del 2026-09-13](2026-09-13-valentina-walk.md) |
| V06 | El nombre del docente en la ficha de cátedra es texto sin link; la página del docente solo se alcanza desde el buscador. | SC-035, US-132 | Resuelto: "Martín Pérez" es un link en la ficha de la cátedra hacia su página, con "Sus cátedras" (R6, tarea 9, [#489](https://github.com/lucasidev/plan-b/issues/489); verificado el 2026-09-13) |
...
| V10 | La lista de materias del plan no marca cuáles tienen ficha; la cobertura "1 de 21" de la carrera no se puede ubicar sin entrar materia por materia. | US-134, US-138 | Resuelto (R6, tarea 9, [#489](https://github.com/lucasidev/plan-b/issues/489)); sin ejercer en el [recorrido del 2026-09-13](2026-09-13-valentina-walk.md) |
| V11 | "Ver las 21 materias" lleva a los planes de estudio y no a las materias: un paso más cuando hay un solo plan. | US-222 | Resuelto (R6, tarea 8, [#488](https://github.com/lucasidev/plan-b/issues/488)); sin ejercer en el recorrido del 2026-09-13 |
| V12 | La comparación contra las cátedras hermanas no se observa en Pérez ni en González; no se puede distinguir si los intervalos se tocan o si no está construida. | US-129, Método | Cerrado: la comparación existe y la ficha publica solo los contrastes que sobreviven a Wilson (`chair-facts-sheet.tsx`); entre Pérez y González los intervalos se tocan y la ficha se calla, como dice Método. Que el corpus no tenga un par de hermanas que difieran es V16 del [recorrido del 2026-09-13](2026-09-13-valentina-walk.md) |
| V13 | En un celular de 393 px la ficha de cátedra desborda 35 px hacia el costado: el buscador del header es más ancho que la pantalla. Método no desborda. | restricción de accesibilidad y celular | Resuelto: a 393 px la ficha de Pérez y Método miden 393 sobre 393 (R6, tarea 10, [#490](https://github.com/lucasidev/plan-b/issues/490); verificado el 2026-09-13) |
| V14 | Método no dice la postura de no tener acuerdos con instituciones; la palabra "acuerdo" no aparece. Lo más cercano es "ni instituciones destacadas o patrocinadas", y la respuesta de la entrada ("Las universidades no lo operan ni deciden qué se publica") no está en la pantalla que es dueña de esa story. | US-185 | Resuelto: Método dice "No tenemos acuerdos con ninguna institución, pagos ni de palabra… Eso incluye a UNSTA" (R6, tarea 16, [#496](https://github.com/lucasidev/plan-b/issues/496); verificado el 2026-09-13) |
