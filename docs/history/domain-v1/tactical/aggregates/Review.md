...
| `Edit(changes)` | Member autor desde UI | Solo permitido desde `published` ([ADR-0012](../../../../decisions/0012-review-editing-blocked-while-a-report-moderates-it.md)). Re-corre filter. Marca "editada después de respuesta" si ya hay `TeacherResponse`. Emite `ReviewEdited`. |
...
| `Restore(restoredBy)` | Moderator/admin desde audit | Vuelve a `published` desde `removed` o `under_review`. Sin reversión cascade ([ADR-0011](../../../../decisions/0011-cascade-on-uphold-with-no-reversal-on-restore.md)). Emite `ReviewRestored`. |
...
|---|---|---|
| `ReviewPublished` | Tras `Publish` con verdict Clean | Moderation (audit log), pipeline de embedding gated ([ADR-0013](../../../../decisions/0013-embedding-generation-gated-on-transitions-to-published.md)) |
...
- State machine `Status`: `published | under_review | removed`. Edit desde `published`, y desde `under_review` cuando `under_review_reason` no es `reports` ([ADR-0012](../../../../decisions/0012-review-editing-blocked-while-a-report-moderates-it.md) y su revisión del 2026-07-29).
...
- ADRs: [ADR-0005](../../../../decisions/0005-review-anchored-to-the-enrollment-record.md), [ADR-0007](../../../../decisions/0007-pgvector-deferred-until-there-is-a-real-consumer.md), [ADR-0009](../../../../decisions/0009-review-anonymity-is-a-presentation-rule.md), [ADR-0011](../../../../decisions/0011-cascade-on-uphold-with-no-reversal-on-restore.md), [ADR-0012](../../../../decisions/0012-review-editing-blocked-while-a-report-moderates-it.md), [ADR-0013](../../../../decisions/0013-embedding-generation-gated-on-transitions-to-published.md), [ADR-0028](../../../../decisions/0028-optional-reviews-with-premium-features-as-reward.md), [ADR-0032](../../../../decisions/0032-destructive-enrollment-edit-invalidates-its-review.md)
- User Stories: [US-050](../../stories/US-050.md), [US-051](../../stories/US-051.md), [US-052](../../stories/US-052.md), [US-053](../../stories/US-053.md), [US-067](../../stories/US-067.md), [US-058](../../stories/US-058.md)
