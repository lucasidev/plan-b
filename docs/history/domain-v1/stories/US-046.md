...
- [x] Hook `useActiveAcademicPeriod` que calcule el período activo (mock por ahora). Confirmado `features/plan/hooks/use-active-academic-period.ts`. US-064 (AcademicTerm) ya cerró (S9) pero este hook no se conectó a datos reales en este requerimiento.
...
- Mockups (3 artboards de la sección ⑥ Planificar del canvas + 1 modal):
  - ![En curso](../../design-v1/reference/screenshots/sim-v2-plan-curso.png)
  - ![Borrador 2027·1c](../../design-v1/reference/screenshots/sim-v2-plan-borr.png)
  - ![Planificar · sin borradores](../../design-v1/reference/screenshots/sim-v2-plan-empty.png)
  - ![Publicar plan del cuatri](../../design-v1/reference/screenshots/sim-v2-modal-publicar.png)
