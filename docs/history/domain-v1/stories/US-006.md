# US-006: Merge de Subjects duplicados (admin)

**Status**: Superada por BO1-7 (vincular y fusionar materias contra la canónica). Era: Backlog
...
**ADR refs**: [ADR-0041](../../../decisions/0041-ux-redesign-after-claude-design.md), [ADR-0030](../../../decisions/0030-cross-bc-consistency-via-wolverine-outbox.md)
...
- [ ] **Backend**: endpoint `POST /api/academic/subjects/merge` con body `{ survivorId, mergedId, fieldChoices: {[field]: 'A'|'B'} }`. El handler:
  - En transacción:
...
- [ ] Endpoint Carter `POST /api/academic/subjects/merge`.
...
- **Depende de**: [US-062](US-062.md) (Subject CRUD), [US-007](US-007.md) (importador detecta duplicados que disparan merge).
...
- Mockup: ![Merge de duplicados](../../design-v1/reference/screenshots/admin-datos-adm-mat-merge.png). Fuente JSX en `canvas-mocks/admin-screens-2.jsx::AdmMateriasMerge`.
- ADRs: [ADR-0041](../../../decisions/0041-ux-redesign-after-claude-design.md), [ADR-0030](../../../decisions/0030-cross-bc-consistency-via-wolverine-outbox.md).
- US relacionadas: [US-062](US-062.md), [US-007](US-007.md), [US-053](US-053.md).
