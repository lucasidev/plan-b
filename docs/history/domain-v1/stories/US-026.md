...
> **Fusionada en [US-023](US-023.md)** al planificar S11 (2026-07-23): el `DELETE` de su AC ya cubría el borrado; mantenerla separada era fragmentación sin valor.
...
- Use Case: ninguno.
- Mockup: ![Descartar borrador](../../design-v1/reference/screenshots/sim-v2-modal-descartar.png). Fuente JSX en `canvas-mocks/v2-modals.jsx::V2ModalDescartarBorrador`.
- ADRs: [ADR-0029](../../../decisions/0029-planning-as-a-separate-bounded-context.md), [ADR-0041](../../../decisions/0041-ux-redesign-after-claude-design.md).
