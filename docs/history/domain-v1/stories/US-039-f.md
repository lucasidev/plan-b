# US-039-f: Estado offline (banner global + acciones en pausa)

**Status**: Superada por las Restricciones del catálogo (disponibilidad de lo público) y la pantalla Error. Era: Planificada
**Sprint**: S10
...
- Mockup: ![Inicio · sin conexión](../../design-v1/reference/screenshots/home-v2-inicio-offline.png). Fuente JSX en `canvas-mocks/v2-empty.jsx::V2OfflineBanner`.
