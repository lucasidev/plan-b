...
**Status**: Superada por BO1-7 y BO5-1 (materia canónica; la reseña se pega al período y a la materia canónica). Era: Backlog
...
**ADR refs**: [ADR-0002](../../../decisions/0002-explicit-versioning-of-career-plans.md), [ADR-0030](../../../decisions/0030-cross-bc-consistency-via-wolverine-outbox.md), [ADR-0041](../../../decisions/0041-ux-redesign-after-claude-design.md)
...
- [ ] **Endpoint backend**: `POST /api/academic/migrations/{id}/apply`. Devuelve 202 con jobId; el job procesa async.
...
- [ ] Endpoint Carter `POST /api/academic/migrations/{id}/apply` + `GET /api/academic/migrations/{id}/status`.
...
- **Depende de**: [US-061](US-061.md) (CareerPlan + versionado), [US-013](US-013.md) (cargar historial, alimenta los EnrollmentRecord), [US-007](US-007.md) (importador genera el plan nuevo antes de migrar).
...
- Mockup: ![Migración de plan](../../design-v1/reference/screenshots/admin-ops-adm-mig.png). Fuente JSX en `canvas-mocks/admin-screens-3.jsx::AdmMigracionPlan`.
- ADRs: [ADR-0002](../../../decisions/0002-explicit-versioning-of-career-plans.md), [ADR-0030](../../../decisions/0030-cross-bc-consistency-via-wolverine-outbox.md), [ADR-0041](../../../decisions/0041-ux-redesign-after-claude-design.md).
- US relacionadas: [US-061](US-061.md), [US-007](US-007.md), [US-013](US-013.md), [US-077-f](US-077-f.md).
