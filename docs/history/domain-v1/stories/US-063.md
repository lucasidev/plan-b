...
- Mockups admin canvas (sección ① + ②):
  - ![Wizard step 4 · Catálogo inicial](../../design-v1/reference/screenshots/admin-onb-adm-onb-4.png)
  - ![Docentes · listado con flags de calidad](../../design-v1/reference/screenshots/admin-datos-adm-doc-list.png)
