# US-009-f: Páginas de error globales (404 + 5xx)

**Status**: Superada por la pantalla Error del mapa (product-map.md), que entra con la primera pantalla pública nueva. Era: Planificada
**Sprint**: S10
...
- [ ] **Card central** (`V2ErrorCard`):
  ...
  - 2 CTAs: `← Volver al inicio` (primary, navega a `/home` o `/` según session) + `Buscar (⌘K)` (ghost, abre el `<GlobalSearch/>` de US-056/US-056-f cuando aterrice).
...
6. **Given** ghost link "Buscar (⌘K)" del 404, **when** Lucía clickea, **then** abre el global search de US-056 (cuando aterrice; antes: stub).
...
- **Relacionada con**: [US-073](US-073.md) (Ayuda, donde apunta el "Reportar problema"), [US-056](US-056.md) (búsqueda global, donde apunta el ghost link del 404).

## Refs

- DoD: [Definition of Done](../../../plan/definition-of-done.md)
- Mockups:
  - ![404 · No encontrado](../../design-v1/reference/screenshots/home-v2-err-404.png). Fuente JSX en `canvas-mocks/v2-errors.jsx::V2Error404`.
  - ![500 · Algo se rompió](../../design-v1/reference/screenshots/home-v2-err-5xx.png). Fuente JSX en `canvas-mocks/v2-errors.jsx::V2Error5xx`.
- ADRs: [ADR-0041](../../../decisions/0041-ux-redesign-after-claude-design.md).
- US relacionadas: [US-073](US-073.md), [US-056](US-056.md).
