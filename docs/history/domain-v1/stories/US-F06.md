...
- [x] `docs/domain/epics.md` y `docs/product/README.md` (este último split posterior en archivos individuales).
...
- **`docs/product/README.md` se splittió en archivos individuales**: cada US tiene archivo propio para que las modificaciones de detalle (acceptance criteria, subtasks, status) no compitan en el mismo file. El `user-stories.md` original quedó como índice.
