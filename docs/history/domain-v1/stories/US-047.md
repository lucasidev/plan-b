...
- [x] Sección "Zona peligrosa" al pie con CTA "Dar de baja mi cuenta". **El flow real es [US-038-bis](US-038-bis.md) (ADR-0044), no US-075**: US-075 fue cancelada por ese ADR antes de este requerimiento (ver `US-038-bis.md`). Confirmado en `app/(member)/my-profile/page.tsx`: `<DeactivateAccountButton>` de `features/deactivate-account`, con comentario explícito "Danger zone... (ADR-0044, US-038-bis frontend)".
...
- Mockups (2 artboards de la sección ⑩ Cuenta del canvas):
  - ![Mi perfil](../../design-v1/reference/screenshots/cuenta-v2-perfil.png)
  - ![Ajustes](../../design-v1/reference/screenshots/cuenta-v2-ajustes.png)
