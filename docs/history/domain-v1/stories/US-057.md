# US-057: Rankings (top 10 paginado: docentes / materias / comisiones)
...
Cancelada el 2026-08-16 por tesis, no por prioridad: "no es un buscador de carreras, ni un ranking". Un ranking ordena instituciones para el que mira de afuera; el producto publica el dato con su atribución para el que está adentro.
...
- Mockup: ![Rankings](../../design-v1/reference/screenshots/rankings-v2-rankings.png). Fuente JSX en `canvas-mocks/v2-screens-2.jsx::V2Rankings` líneas 284-404.
