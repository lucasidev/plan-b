...
- [x] Ruta `/reseñas` (route group `(member)`) con tabs:
...
- [x] `GET /api/reviews/me/pending` (cursadas finalizadas sin review).
- [x] `GET /api/reviews/me` (mías).
- [x] Tests integration por endpoint.

### Frontend

- [x] `app/(member)/reseñas/page.tsx` con tabs.
- [ ] `features/browse-reviews/{api.ts,components/{review-card,filter-sidebar,explore-feed}.tsx}`.
- [x] `features/pending-reviews/{api.ts,components/pending-list.tsx}`.
- [x] `features/my-reviews/{api.ts,components/{my-reviews-list,my-stats-header}.tsx}`.
- [x] Sidebar v2: agregar entrada "Reseñas" en sección Producto.
...
- Mockups (5 artboards de la sección ⑦ Reseñas del canvas, del shell con tabs + empty states):
  - ![Explorar](../../design-v1/reference/screenshots/resenas-v2-resenas-l.png)
  - ![Pendientes](../../design-v1/reference/screenshots/resenas-v2-resenas-e.png)
  - ![Pendientes · al día](../../design-v1/reference/screenshots/resenas-v2-resenas-e-empty.png)
  - ![Mis reseñas](../../design-v1/reference/screenshots/resenas-v2-resenas-m.png)
  - ![Mis reseñas · primera vez](../../design-v1/reference/screenshots/resenas-v2-resenas-m-empty.png)
