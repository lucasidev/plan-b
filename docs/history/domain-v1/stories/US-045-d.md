...
Cuarto slice del rebuild de Mi carrera. Cubre 2 tabs (Catálogo y Docentes) en un solo requerimiento porque comparten queries del módulo Academic + reseñas, y los drawers cierran el loop visual de los tabs anteriores (Plan + Correlativas linkean al drawer de materia).
...
- Mockups (4 artboards):
  ...
  - ![Materia · detalle (drawer)](../../design-v1/reference/screenshots/plan-v2-mat-detail.png)
  - ![Docentes](../../design-v1/reference/screenshots/plan-v2-carrera-d.png)
  - ![Docente · detalle (drawer)](../../design-v1/reference/screenshots/plan-v2-doc-detail.png)
