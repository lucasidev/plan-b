...
- [x] Ruta `/sobre` accesible tanto desde `(public)` como desde `(member)` (no requiere auth).
- [x] Acceso autenticado desde **ítem "Sobre plan-b" en sección "Otros"** del sidebar v2.
...
- [x] `app/(public)/sobre/page.tsx` (también linkeable desde `(member)`).
- [x] `features/about/components/{hero,what-is-it,universities-list,how-it-works,credits,open-source-cta,version-info}.tsx`.
- [x] Contenido en MD o JSX directo. MD si pensamos que va a editarse seguido; JSX si es estático.
- [x] Sidebar v2: agregar "Sobre plan-b" en sección "Otros".
...
- Mockup: ![Sobre plan-b](../../design-v1/reference/screenshots/soporte-v2-sobre.png). Fuente JSX en `canvas-mocks/v2-screens-2.jsx::V2Sobre` líneas 491-600.
