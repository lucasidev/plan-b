# ADR-0047: Public pass rate from the private enrollment history
...
- [ADR-0009](0009-review-anonymity-is-a-presentation-rule.md) (anonimato opt-in de reseñas, el contraste con el historial privado).
