...
- Ocho stories en [Replicar](../product/reply/README.md): cinco con rol "el docente", dos con rol "la institución", una de quien ya aportó. **Las dos de la institución no tienen camino de verificación**: la pantalla [Verificar](../product/care-for-what-is-published/screens/SC-022-verify/README.md) tiene dos tarjetas (alumno, docente), no tres.
