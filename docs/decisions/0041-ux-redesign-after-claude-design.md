# ADR-0041: UX redesign after claude-design (delta and migration plan)
...
3. **Meilisearch** como motor de búsqueda global ([ADR-0039](0039-meilisearch-as-the-global-search-engine.md)).
4. **Notifications** como bounded context nuevo ([ADR-0040](0040-notifications-as-a-new-bounded-context.md)).
