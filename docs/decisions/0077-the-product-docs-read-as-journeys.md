...
- **Quedan tres dudas de clasificación anotadas, y son deuda de esta decisión**: si Mi carrera y Cuidar lo publicado son tramos propios o se funden en un vecino (tres stories cada uno es poco tramo); si Llevarse el dato es del alumno o de otro actor (la mitad de sus stories son promesas del producto, no acciones de nadie); y las tres stories de lectura que quedaron en Replicar (US-173, US-174, US-177 leen como Elegir dónde estudiar). Se resuelven tramo por tramo, no hacían falta para mover.
