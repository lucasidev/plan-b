...
- **Fecha**: 2026-08-23
- **Precisa**: [ADR-0064](0064-phrases-with-voices-not-scores.md), [ADR-0065](0065-attribution-is-the-axis-not-a-split.md), [ADR-0075](0075-the-published-proportion-has-a-z-a-denominator-and-one-voice-per-cursada.md)
