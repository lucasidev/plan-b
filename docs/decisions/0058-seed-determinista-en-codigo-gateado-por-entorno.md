# ADR-0058: Seed determinista en código, gateado por entorno
...
- El seeder es el único caller de los métodos `Hydrate` de los aggregates, que saltean validación. Ese es justamente el camino que motivó replicar invariantes como constraints de base ([ADR-0052](0052-constraints-de-db-como-red-de-invariantes.md)); `Commission.Hydrate` ya se cerró para que valide y tire.
...
- [ADR-0052](0052-constraints-de-db-como-red-de-invariantes.md): la red de base para los caminos que saltean el dominio, el seeder entre ellos.
