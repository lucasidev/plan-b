# ADR-0033: VerificationToken as a child entity, not an independent aggregate
...
Refs: [ADR-0008](0008-exclusive-roles-with-profiles-as-capability-unlockers.md), [ADR-0017](0017-persistence-ignorance.md), [ADR-0030](0030-cross-bc-consistency-via-wolverine-outbox.md). Ver también `docs/history/domain-v1/tactical/aggregates.md` para el catálogo completo de aggregates / entities / VOs / projections.
