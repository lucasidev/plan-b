# ADR-0032: A destructive edit of an EnrollmentRecord invalidates its Review
...
Una `Review` se ancla a un `EnrollmentRecord` específico (ver [ADR-0005](0005-review-anchored-to-the-enrollment-record.md)). El alumno puede editar el EnrollmentRecord ([UC-015](../history/domain-v1/use-cases/UC-015.md)): corregir status, grade, approval_method, etc. Eso introduce un riesgo:
...
Refs: [ADR-0005](0005-review-anchored-to-the-enrollment-record.md), [ADR-0011](0011-cascade-on-uphold-with-no-reversal-on-restore.md), [ADR-0012](0012-review-editing-blocked-while-a-report-moderates-it.md), [ADR-0030](0030-cross-bc-consistency-via-wolverine-outbox.md).
