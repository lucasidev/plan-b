# ADR-0013: Embedding generation gated on transitions to published
...
> [ADR-0007](0007-pgvector-deferred-until-there-is-a-real-consumer.md) borró el andamiaje de pgvector porque el
...
Según [ADR-0007](0007-pgvector-deferred-until-there-is-a-real-consumer.md), el pipeline de generación de embeddings corre desde día 1, aunque la feature UI que los usa está gated off hasta tener volumen de reseñas.
...
- Pipeline de embeddings descripto en [ADR-0007](0007-pgvector-deferred-until-there-is-a-real-consumer.md).
