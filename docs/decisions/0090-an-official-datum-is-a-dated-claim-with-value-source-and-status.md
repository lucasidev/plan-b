...
- **Dónde estudiarla** ([SC-008](../product/student/choose-where-to-study/screens/SC-008-where-to-study/README.md)): la misma carrera canónica en las instituciones de la misma aglomeración, los mismos seis campos con la misma forma por tarjeta, cada celda con su estado; sin compuesto ni ganador; con una sola oferta cargada, "no hay con qué comparar todavía". Los sesgos de un derivado se dicen una vez, arriba, y no por tarjeta.
