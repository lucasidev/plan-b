# ADR-0031: ReviewAuditLog as a projection, not an aggregate
...
Refs: [ADR-0011](0011-cascade-on-uphold-with-no-reversal-on-restore.md), [ADR-0030](0030-cross-bc-consistency-via-wolverine-outbox.md).
