...
- [ADR-0070](0070-product-requirements-are-vertical-by-capability-and-design-is-text.md) (el corte vertical y las cinco carpetas), [ADR-0036](0036-testing-pyramid-cross-stack.md) (qué test para qué cosa), [ADR-0026](0026-git-workflow-github-flow-con-rebase.md) (la rama y el PR que citan el ID), [ADR-0037](0037-changelog-automation-auto-append.md) (el changelog que sale de los commits).
