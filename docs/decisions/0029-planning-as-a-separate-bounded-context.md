# ADR-0029: Planning as a bounded context separate from Enrollments
...
Refs: [ADR-0014](0014-modular-monolith-with-bounded-contexts-as-modules.md) (modular monolith pattern), [ADR-0028](0028-optional-reviews-with-premium-features-as-reward.md) (premium features como reward).
