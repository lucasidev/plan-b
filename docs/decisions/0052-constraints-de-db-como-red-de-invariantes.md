# ADR-0052: Constraints de base de datos como red de los invariantes del aggregate
...
- [ADR-0033](0033-verification-token-como-child-entity.md): el invariante de un token activo por purpose, que acá recibe su red.
- [ADR-0047](0047-pass-rate-publico-desde-historial-privado.md): el pass rate público, que es lo que los duplicados de cursada ensucian.
