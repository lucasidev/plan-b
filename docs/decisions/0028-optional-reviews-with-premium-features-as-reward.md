# ADR-0028: Optional reviews with premium features as a reward, not a gate
...
- Aparece BC `Planning` con aggregate `SimulationDraft`. Ver [ADR-0029](0029-planning-as-a-separate-bounded-context.md).
...
Refs: [ADR-0005](0005-review-anchored-to-the-enrollment-record.md) (Review anclada a EnrollmentRecord), [ADR-0029](0029-planning-as-a-separate-bounded-context.md) (Planning BC).
