# ADR-0057: Soft delete when something hangs off it, hard delete when nothing does
...
| User | Baja de cuenta con anonimización de PII | `disabled_at` + hash del email ([ADR-0044](0044-soft-delete-of-the-user-with-corpus-preservation.md)) |
...
- [ADR-0044](0044-soft-delete-of-the-user-with-corpus-preservation.md): el caso más elaborado (baja de cuenta con anonimización de PII y preservación del corpus de reseñas), que este ADR generaliza al resto.
- [ADR-0052](0052-database-constraints-as-a-net-under-aggregate-invariants.md): por qué los UNIQUE viven en la base además del aggregate.
- [`docs/engineering/data-model.md`](../engineering/data-model.md): qué marca lleva cada entidad.
