# ADR-0040: Notifications as a new bounded context

- **Estado**: aceptado, revalidado por [ADR-0063](0063-the-product-is-a-pressure-instrument.md) (los avisos sostienen cinco stories del producto nuevo y son infraestructura del primer bloque, arrancando por mail; ver [product-map.md](../product/map.md))
- **Fecha**: 2026-05-02
