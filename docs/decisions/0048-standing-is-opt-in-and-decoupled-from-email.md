# ADR-0048: Student and teacher standing is opt-in and decoupled from email
...
- Docs a reconciliar: US-031, `docs/history/domain-v1/verification-flows.md`, `docs/engineering/data-model.md`, `docs/product/language.md`.
- Decisiones relacionadas: [ADR-0001](0001-multi-university-as-root-domain-from-day-1.md), [ADR-0008](0008-exclusive-roles-with-profiles-as-capability-unlockers.md), [ADR-0023](0023-auth-flow-jwt-cookie-layout-guards.md), [ADR-0033](0033-verification-token-as-a-child-entity.md).
