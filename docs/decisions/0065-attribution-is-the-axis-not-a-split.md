# ADR-0065: Attribution is the axis, published as two proportions of people, never a split
...
La tesis promete responder la pregunta de quien está eligiendo (O1-3): *si lo que hace difícil a una carrera es la carrera o la facultad, porque una cosa la elijo y la otra la sufro*. A eso le llamamos **atribución**. La intención original (decisión 2 de la tesis, tal como aterrizó con [ADR-0063](0063-the-product-is-a-pressure-instrument.md)) la calculaba desde el cruce sujeto × eje de cada frase: exigencia-materia = "la carrera siendo dura"; gestión-cátedra o gestión-institución = "alguien fallando"; y prometía un split: "de todo lo que la hace difícil, el 65% es la institución fallando".

Tres cosas rompieron esa regla al intentar modelarla:

1. **La matriz tiene seis celdas y la regla cubre tres.** "Contenido de hace diez años" es sujeto materia y eje gestión: alguien falla, y la regla la manda a "carrera dura" o a ningún lado. "Te la estudiás solo" es sujeto cátedra y eje exigencia: la regla no la asigna. Y las dos están en el corpus del mapa (hallazgo G1 de la [revisión del catálogo](../domain/catalog-review-2026-08-16.md)).
...
**D. El split de marcas como número de cabecera** ("el 65% de lo difícil es la institución"). Es la promesa original y la más golpeadora. Descartada por las tres razones del contexto: depende de cuántas frases hay por eje en el catálogo, fuerza una complementariedad falsa, y no es la unidad de 0064. Dos proporciones de personas pegan igual y son defendibles.
...
- **La cabecera de la ficha son dos proporciones de personas**, una por eje, con el mismo denominador y con Wilson. La cabecera y las listas cuentan lo mismo de dos maneras: no hay un tercer número.
...
- **Riesgo aceptado**: la proporción de personas por eje sigue siendo algo sensible a cuántas frases hay por eje (más frases de gestión, más chances de marcar al menos una). Menos que el split, más que la proporción por frase, que es inmune. Se mitiga con un catálogo balanceado y publicado, no con una fórmula.
...
- [THESIS.md](../THESIS.md), decisión 2 y "Qué publicamos". [ADR-0064](0064-phrases-with-voices-not-scores.md): la unidad de publicación (proporción de personas por frase y por eje, con Wilson) que esta decisión aplica a la atribución. **Completa** a 0064.
...
- Hallazgo G1 de la [revisión del catálogo del 2026-08-16](../domain/catalog-review-2026-08-16.md) y hallazgo 3 de la auditoría del [product-map](../domain/product-map.md).
