...
1. **La matriz tiene seis celdas y la regla cubre tres.** "Contenido de hace diez años" es sujeto materia y eje gestión: alguien falla, y la regla la manda a "carrera dura" o a ningún lado. "Te la estudiás solo" es sujeto cátedra y eje exigencia: la regla no la asigna. Y las dos están en el corpus del mapa (hallazgo G1 de la [revisión del catálogo](../reviews/2026-08-16-catalog.md)).
