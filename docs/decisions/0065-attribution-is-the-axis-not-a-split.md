...
1. **La matriz tiene seis celdas y la regla cubre tres.** "Contenido de hace diez años" es sujeto materia y eje gestión: alguien falla, y la regla la manda a "carrera dura" o a ningún lado. "Exigen mucho, y se puede" es sujeto cátedra y eje exigencia: la regla la manda a "alguien falla", que es lo contrario de lo que dice. La primera está en el corpus del mapa (hallazgo G1 de la [revisión del catálogo](../reviews/2026-08-16-catalog.md)); la segunda, en el [catálogo de frases](../domain/phrases.md) (F28), donde "Te la estudiás solo" quedó como cátedra y gestión: la cátedra que no enseña, no la materia que es difícil (F16).
