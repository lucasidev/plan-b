...
La tesis original (16 de agosto, primera versión) proponía: se tocan frases predefinidas y curadas por nosotros; de sus conteos salen **dos números** por sujeto, exigencia y gestión, en escala 1 a 5, "con encogimiento hacia el medio según cuánta gente habló". La auditoría de lo publicable (la [revisión adversarial del catálogo](../reviews/2026-08-16-catalog.md) y la mesa que siguió) mostró que ese diseño tenía tres agujeros y que ninguno era de implementación:
