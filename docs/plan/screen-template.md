...
- **Los invariantes del producto valen acá también**: gestión alarma y exigencia informa ([ADR-0065](../decisions/0065-attribution-is-the-axis-not-a-split.md)), toda proporción con sus voces y su encogimiento ([ADR-0064](../decisions/0064-phrases-with-voices-not-scores.md)), y los períodos nunca codificados ([ADR-0051](../decisions/0051-vocabulario-academico-canonico-en-la-ui.md)). Una pantalla que los rompe está mal aunque respete este contrato.
