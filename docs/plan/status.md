...
| # | Tarea | Pts | Estado |
|---|---|---|---|
| [#495](https://github.com/lucasidev/plan-b/issues/495) · 15 | **Los recorridos sobre lo nuevo**: Valentina y Lucía repetidos contra el stage con lo construido, con lo que el arnés dejó sin ejercer (Corregir, cerrar sesión, la baja y el conteo después de borrar: L08) y la fama y la comparación sobre Ibáñez (V05, V12); y el tramo con cuenta de `just stage-walk` sobre el stage rellenado ([#470](https://github.com/lucasidev/plan-b/issues/470)). | 4 | En construcción |
