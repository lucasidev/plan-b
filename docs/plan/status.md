...
| [#488](https://github.com/lucasidev/plan-b/issues/488) · 8 | **Explorar por carrera**: la segunda lente, y `/careers` y `/subjects` dejan de responder 404 (US-222; V03, V11). | 3 | En construcción |
| [#489](https://github.com/lucasidev/plan-b/issues/489) · 9 | **De la ficha al docente y del plan a la ficha**: el nombre del docente lleva a su página, y la lista de materias del plan marca cuáles tienen ficha (US-134; V06, V10). | 3 | En construcción |
| [#490](https://github.com/lucasidev/plan-b/issues/490) · 10 | **La ficha no desborda en celular**: el buscador del header entra en 393 px (V13). | 1 | En construcción |
...
| [#496](https://github.com/lucasidev/plan-b/issues/496) · 16 | **Las fichas que faltan y la postura de Método**: SC-036 Curaduría para `/admin/curation`; `/admin/chairs` y `/admin/teachers` documentadas en SC-027, y `/careers/[id]/plans` y `/plans/[id]/subjects` en SC-001 (E02); Método dice que no hay acuerdos con instituciones (US-185, V14). | 2 | Hecho, en docs: SC-036 y las sub-rutas quedaron documentadas (E02); la ficha, el boceto y la story de Método ya declaraban la postura de US-185 antes de esta tarea, así que V14 sigue abierto en el código (`/method` no muestra la frase todavía) |
