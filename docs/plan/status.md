...
| # | Issue | Pts | Qué gatea |
|---|---|---|---|
| 1 | [TK-348 · Cerrar ADR-0075 y ADR-0076](https://github.com/lucasidev/plan-b/issues/348) | 1 | ✓ cerrado 2026-08-24: los dos aceptados |
| 2 | [TK-349 · Rescatar el evaluador a academic](https://github.com/lucasidev/plan-b/issues/349) | 3 | la poda: va antes, o US-144 pierde su lógica |
| 3 | [TK-350 · Podar planning entero](https://github.com/lucasidev/plan-b/issues/350) | 5 | el criterio 1 de salida (cero Planning en backend) |
| 4 | [TK-351 · Arreglar la fuga de enumeración](https://github.com/lucasidev/plan-b/issues/351) | 3 | nada: independiente; su test es el primero del régimen nuevo |
| 5 | [TK-353 · Rehacer el mapeo del inventario](https://github.com/lucasidev/plan-b/issues/353) | 3 | la planificación de R1: sin esto se planifica contra referencias muertas |
| 6 | [TK-352 · Propagar ADR-0078](https://github.com/lucasidev/plan-b/issues/352) | 5 | la ficha: la política de muestra chica se decide acá; la curaduría es sesión con Lucas |
...
|---|---|---|---|
| 1 | [TK-355 · Propagar el modelo a la spec de Reseñar](https://github.com/lucasidev/plan-b/issues/355) | 3 | nada; incluye el barrido de stories y screens que los agentes mapearon el 2026-08-25 |
| 2 | [TK-356 · La cátedra como entidad en academic](https://github.com/lucasidev/plan-b/issues/356) | 5 | nada; el titular por período queda registrado para el corte "cambio de titular" |
| 3 | [TK-357 · El catálogo de frases versionado a la base](https://github.com/lucasidev/plan-b/issues/357) | 2 | 1; frases con código estable, opciones, instrumento con vigencias ([phrases.md](../product/phrases.md) es la fuente editorial) |
| 4 | [TK-358 · La reseña de tres capas](https://github.com/lucasidev/plan-b/issues/358) | 8 | 2, 3; respuestas por opción atadas a la versión del instrumento + contexto no publicado + campo libre no publicado + una voz por cuenta × materia × período |
| 5 | [TK-359 · La pantalla Reseñar](https://github.com/lucasidev/plan-b/issues/359) | 8 | 1, 4; el boceto vigente es el sketch de SC-015 |
| 6 | [TK-360 · La ficha mínima de cátedra](https://github.com/lucasidev/plan-b/issues/360) (redefinida el 2026-08-25: conteos con moda y distribución, fama por convergencia, tasa de finalización agregada, piso de 10) | 5 | 4 |
| 7 | [TK-361 · El E2E del ciclo completo](https://github.com/lucasidev/plan-b/issues/361) | 3 | 5, 6 |
...
| # | Issue | Pts | Depende de |
|---|---|---|---|
| 1 | [TK-363 · La ficha de materia deriva de sus cátedras](https://github.com/lucasidev/plan-b/issues/363) | 8 | nada |
| 2 | [TK-364 · Se llega a la cátedra desde donde se la busca](https://github.com/lucasidev/plan-b/issues/364) | 5 | 1 |
| 3 | [TK-365 · Editar y borrar lo que conté](https://github.com/lucasidev/plan-b/issues/365) | 8 | nada |
| 4 | [TK-366 · La landing dice lo que el producto hace](https://github.com/lucasidev/plan-b/issues/366) | 5 | 1 |
| 5 | [TK-367 · Se poda el aggregate de reseña anterior y su moderación](https://github.com/lucasidev/plan-b/issues/367) | 13 | 1, 3, 4 |
| 6 | [TK-368 · El E2E del camino a la ficha y del deshacer](https://github.com/lucasidev/plan-b/issues/368) | 3 | todos |
...
| # | Issue | Pts | Depende de |
|---|---|---|---|
| 1 | [TK-370 · La cátedra se carga desde el backoffice](https://github.com/lucasidev/plan-b/issues/370) | 8 | nada; el dominio de `Chair` ya está entero, faltan los features y la pantalla |
| 2 | [TK-371 · Se poda el seguimiento de carrera](https://github.com/lucasidev/plan-b/issues/371) | 18 | nada; primero **muda** la declaración de carrera al Registro, después poda `/onboarding`, `/my-career` y `enrollments`, y cierra los 17 ADRs que citan el módulo |
| 3 | [TK-372 · La ficha publica con qué se llevó la materia](https://github.com/lucasidev/plan-b/issues/372) | 5 | se verifica con 5; el modelo ya lo soporta, es un self-join |
| 4 | [TK-373 · Método publica cómo se calcula cada número](https://github.com/lucasidev/plan-b/issues/373) | 5 | nada; el dato ya existe entero, es pantalla y copy |
| 5 | [TK-374 · El corpus de prueba del modelo vigente](https://github.com/lucasidev/plan-b/issues/374) | 3 | 1 |
| 6 | [TK-375 · Los huecos que dejaron las podas](https://github.com/lucasidev/plan-b/issues/375) | 5 | el renaming `Review` → `Review` se lleva 3 él solo |
| 7 | [TK-376 · El E2E de cargar una cátedra y ver su dato](https://github.com/lucasidev/plan-b/issues/376) | 3 | todos |
...
**Nadie que no sea alumno podía entrar.** Un pase de QA recorriendo el producto como sus personas encontró que de los cuatro roles solo `member` llegaba a alguna pantalla: el sign-in mandaba a `/home` fijo, que es del alumno, así que un admin rebotaba entre el guard de `(member)` y el de `(auth)`, en bucle y con la sesión creada. Moderación se había retirado en R2 dejando su rol apuntando a una cola que no existe, y `university_staff` nunca tuvo pantalla. Los dos salieron entonces del frontend; la poda posterior del enum quedó en TK-534.
...
| Story | Nombre | Sprint |
|---|---|---|
| US-233 | Contar cómo cursé y cuántas veces | R8 |
| US-234 | Cargar una institución completa | R8 |
...
Del 2026-09-09 al 2026-09-13: planificado a dos semanas, cerrado en cinco días. Milestone [R6](https://github.com/lucasidev/plan-b/milestone/8), issues #481 a #497, #506 y #507, 70 pts en cuatro pistas.
...
| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-481](https://github.com/lucasidev/plan-b/issues/481) · 1 | **El modelo del ADR-0090**: `AcademicUnit` y `OfficialFact` en academic, con migración, read Dapper para las fichas y endpoint de carga con policy de admin y fuente obligatoria (US-194, US-202); `Career.DurationYears` y `CareerPlan.IsOfficial` se retiran cuando sus afirmaciones existen (F03, F04, F06, K04). Listo cuando: una afirmación con cada estado del ADR se guarda, se lee y se ve con su fuente. | 8 | Hecho |
| [TK-482](https://github.com/lucasidev/plan-b/issues/482) · 2 | **El catálogo real de Tucumán**: las cinco instituciones con sede en la provincia según la Guía SIU como entidades reales con su identidad (Siglo 21 queda afuera: la Guía no le lista sede, solo llegada a distancia, y eso es la decisión pendiente); la oferta de programación con sus planes reales (la Tecnicatura de UNSTA ya lo es; UTN Tucumán con la Tecnicatura Universitaria en Programación y el plan de la Ordenanza 987 hasta que el plan 2024 se pueda bajar; UNT con Programador Universitario y el plan de la FACET); el resto de la oferta de pregrado y grado de la Guía cargada como carreras con su duración y su condición de ingreso; la carrera ficticia de UTN retirada, y la entrada dice que las reseñas son sintéticas (K01, K02, K05, US-195). Listo cuando: ninguna institución, carrera ni plan del stage es inventado, y el reset lo rearma igual. | 8 | Hecho |
| [TK-483](https://github.com/lucasidev/plan-b/issues/483) · 3 | **Las afirmaciones relevadas, cargadas**: los datos de las tres ofertas de programación y de las cinco instituciones del [relevamiento](../history/reviews/2026-09-07-official-data-survey.md) que sobreviven a la salida de Siglo 21, por seed y por el backoffice, cada uno con su estado y su fecha; el pedido de egreso y duración real al DIU y a las universidades nacionales, registrado como "pedido" con fecha (O01, O07, O10, O11, K07). Listo cuando: cada dato del relevamiento está en el stage con la misma fuente que en el registro. | 3 | Hecho |
| [TK-484](https://github.com/lucasidev/plan-b/issues/484) · 4 | **La ficha de carrera con sus datos**: el bloque de datos oficiales con fuente y período por dato, el régimen de ingreso, y la acreditación o la validez nacional según el nivel (US-127, US-133, US-130; V01, F02, F05, O03), con los escenarios de US-127 y US-133 reescritos con el dato como criterio (E01). Listo cuando: Valentina lee los seis datos de la Tecnicatura de UNSTA con su fuente, y lo no publicado se dice con fecha. | 5 | Hecho |
| [TK-485](https://github.com/lucasidev/plan-b/issues/485) · 5 | **Dónde estudiarla**: la misma carrera canónica en las instituciones de una misma aglomeración (localidades que el equipo declara como un mismo continuo urbano, ej. Gran San Miguel de Tucumán), con la localidad que normaliza la tarea 19 y caída a la provincia cuando no se pudo resolver; seis datos con la misma forma por tarjeta y cada celda con su estado, sin compuesto ni ganador; la carrera canónica la declara el equipo (US-128, US-195; V02, K02, K03). Listo cuando: la Tecnicatura de UNSTA se compara con las ofertas de UNT y UTN y la pantalla dice qué es cada una. | 6 | Hecho: agrupa por aglomeración declarada, no por localidad suelta, porque la Facultad de Ingeniería de UNSTA resuelve en Yerba Buena y UNT y UTN en San Miguel |
| [TK-486](https://github.com/lucasidev/plan-b/issues/486) · 6 | **La ficha de institución**: cabecera de identidad y checklist de transparencia con una fila por campo y su estado, "no publicado" y "no informado" dichos con fecha, y "Ver fuentes"; la story nueva del checklist (F01), y la auditoría de la AGN que trae la tarea 18 (E05, O04, O06, K07). Listo cuando: las seis instituciones tienen su ficha y UNT muestra su nómina, su presupuesto y su boletín con link. | 4 | Hecho |
| [TK-506](https://github.com/lucasidev/plan-b/issues/506) · 18 | **La auditoría de la AGN, por su API**: paginar `webagnapi.agn.gob.ar/api/views/busqueda_avanzada/informes` entero y filtrar por `organismo_auditado` en local, porque los `filter[...]` de JSON:API no filtran esa vista, y volcar el resultado como afirmaciones del ADR-0090 con su estado y su fecha; sin informes es "no publicado" con la fecha de consulta, y una consulta que falla no deja el dato a medias (O08). Listo cuando: las instituciones del catálogo tienen su afirmación de auditoría con su fuente y su fecha. | 3 | Hecho: se dispara desde el catálogo del backoffice, con un control positivo que aborta antes de escribir si la consulta vuelve vacía |
| [TK-507](https://github.com/lucasidev/plan-b/issues/507) · 19 | **Las sedes, normalizadas contra Georef**: el domicilio de la Guía del SIU trae la ciudad adentro de la cadena y escrita como venga, y Dónde estudiarla se define por ciudad; resolver las nueve localidades de las 229 ofertas contra `apis.datos.gob.ar/georef` al cargar (siete por `/localidades`, las dos rurales por `/asentamientos`) y guardar el id y el nombre canónico junto al domicilio crudo. Sin resolución la comparación cae a la provincia y lo dice; es lo que la tarea 5 necesita para comparar por ciudad y no por provincia (V02). Listo cuando: Dónde estudiarla compara las ofertas de San Miguel de Tucumán entre sí sin mezclarlas con las de Concepción. | 3 | Hecho |
...
| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-487](https://github.com/lucasidev/plan-b/issues/487) · 7 | **Buscar encuentra carreras e instituciones** (US-132; V04). Listo cuando: "Desarrollo y Calidad de Software" devuelve la carrera y "UNSTA" la institución. | 3 | Hecho |
| [TK-488](https://github.com/lucasidev/plan-b/issues/488) · 8 | **Explorar por carrera**: la segunda lente, y `/careers` y `/subjects` dejan de responder 404 (US-222; V03, V11). | 3 | Hecho |
| [TK-489](https://github.com/lucasidev/plan-b/issues/489) · 9 | **De la ficha al docente y del plan a la ficha**: el nombre del docente lleva a su página, y la lista de materias del plan marca cuáles tienen ficha (US-134; V06, V10). | 3 | Hecho |
| [TK-490](https://github.com/lucasidev/plan-b/issues/490) · 10 | **La ficha no desborda en celular**: el buscador del header entra en 393 px (V13). | 1 | Hecho |

### Pista 3 · Reseñar sin fisuras (12 pts)

| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-491](https://github.com/lucasidev/plan-b/issues/491) · 11 | **El click que el router pierde** ([TK-477](https://github.com/lucasidev/plan-b/issues/477)): el fallback a `window.location` cuando la navegación no se aplica en una ventana acotada, y el prefetch del shell autenticado apagado, medidos con repeticiones bajo carga antes y después; si la causa aparece en el tracker de Next, se cita. Listo cuando: doce corridas seguidas de los cuatro specs sin la firma. | 5 | Hecho |
| [TK-492](https://github.com/lucasidev/plan-b/issues/492) · 12 | **La puerta dice el motivo y vuelve**: Ingresar desde "Reseñala" dice para qué, y después de verificar el mail aterriza en la reseña que había empezado (US-229; L01, L03). | 3 | Hecho |
| [TK-493](https://github.com/lucasidev/plan-b/issues/493) · 13 | **El contrato dice el piso y el duplicado no se envía** (US-159, US-163; L04, L06). | 2 | Hecho |
| [TK-494](https://github.com/lucasidev/plan-b/issues/494) · 14 | **Mis aportes por frase**: la opción elegida en cada frase y las voces que suma (US-162; L05). | 2 | Hecho |

### Pista 4 · Verificar y ordenar (8 pts)

| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-495](https://github.com/lucasidev/plan-b/issues/495) · 15 | **Los recorridos sobre lo nuevo**: Valentina y Lucía repetidos contra el stage con lo construido, con lo que el arnés dejó sin ejercer (Corregir, cerrar sesión, la baja y el conteo después de borrar: L08) y la fama y la comparación sobre Ibáñez (V05, V12); y el tramo con cuenta de `just walk copas` sobre el stage rellenado ([TK-470](https://github.com/lucasidev/plan-b/issues/470)). | 4 | Hecho: [Valentina](../history/reviews/2026-09-13-valentina-walk.md) y [Lucía](../history/reviews/2026-09-13-lucia-walk.md) repetidas sobre el stage de R6, con Corregir, Cerrar sesión y la baja con su conteo hechos a mano (L08 resuelto en el producto); V05 y V12 cerrados por regla (V16: ninguna cátedra del corpus converge ni difiere); y el tramo con cuenta de [Copas](../history/reviews/2026-09-13-copas-walk.md) en verde con `just walk copas`; [Matías](../history/reviews/2026-09-13-matias-walk.md) corrió además, por primera vez contra el stage real, y confirmó la baja entera (US-166). V15, L09, L10, L11, P01 y P02 pasan a R7 con destino; V16 descartado: la fama y la comparación sí se publican (Ibáñez y Pérez), la spec de Valentina miraba mal y se corrige en R7 |
...
| [TK-497](https://github.com/lucasidev/plan-b/issues/497) · 17 | **El cierre de R5 en cada registro** ([TK-473](https://github.com/lucasidev/plan-b/issues/473)): cada hallazgo de R5 con su estado cambiado en su registro y el índice al día, y el glosario con Cohorte y Datos oficiales al modelo del ADR (F04). | 2 | Hecho |

### Lo que el sprint encontró caminándolo, y no estaba planificado

R6 se planificó por tareas y se cerró caminando el producto, que es lo que un sprint de arreglo tiene que hacer. Lo que apareció al caminarlo y entró igual:

| Qué | Por qué no podía quedar |
|---|---|
| Registrarse era imposible en 215 de las 225 carreras | El catálogo real se cargó sin planes y el registro exigía uno |
| Reseñar moría fuera de UNSTA | Las materias y los períodos colgaban todos de una institución |
| Nada decía que las reseñas son de demostración | Conteos inventados colgados de instituciones reales con nombre propio |
| La pantalla de ingreso inventaba un cuestionario, y la de registro citaba una reseña individual | La segunda es de lo poco que la tesis prohíbe sin excepción |
| El checklist de transparencia estaba vacío en las cinco instituciones | La tarea 6 estaba marcada como hecha con su criterio incumplido |
| El catálogo no daba ninguna razón para entrar a nada | Con 225 carreras y pocas con datos, el recorrido era casi todo frustración |
...
1. Valentina, sin cuenta, elige entre la Tecnicatura de UNSTA y las ofertas de UNT y UTN leyendo datos oficiales con su fuente, y ninguna institución, carrera ni plan del stage es inventado.
...
7. Los recorridos corrieron sobre lo nuevo y el tramo con cuenta de `just walk copas` pasó.
...
Del 2026-09-14 al 2026-09-18: cuatro días de trabajo y el viernes para mostrar. Milestone [R7](https://github.com/lucasidev/plan-b/milestone/9), issues #517 a #529 y #536, 38 pts en tres pistas.

**Cerrado el 2026-09-17.** Evidencias de aceptación integradas en [#553](https://github.com/lucasidev/plan-b/pull/553) y preparación del corpus de demostración en [#555](https://github.com/lucasidev/plan-b/pull/555). La [verificación final](../history/reviews/2026-09-17-r7-demo-ready.md) conserva los dos incumplimientos fuera de R7 (US-167 y US-180). El tag narrativo queda opcional y se omite en este cierre; la versión de API verificada en stage es `e071ea714897b7e30ab9b4570460c63965181fc4`.
...
| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-517](https://github.com/lucasidev/plan-b/issues/517) · 1 | **El refresh silencioso** (L11, US-229): `middleware.ts` renueva el access token con la cookie de refresh contra `/api/identity/refresh` y rota las cookies en la respuesta; al mergear se borra `JWT__AccessTokenMinutes` de la Application API del stage. Listo cuando: una sesión de una hora sobre el stage no pide entrar de nuevo, sin la variable de Dokploy, y un test cubre el vencimiento con refresh vigente y sin él. | 5 | Hecho: la cookie de refresh en `Path=/`; `middleware.ts` renueva con deadline, agrupa pedidos concurrentes del mismo proceso y no renueva prefetches; Redis consume el token viejo de forma atómica; cerrar sesión borra la cookie vieja ([ADR-0095](../decisions/0095-the-session-renews-itself-in-the-middleware.md)). `session-renews.spec.ts` cubre renovación y revocación contra el stack local. La [prueba visual de una hora](../history/reviews/2026-09-17-r7-session.md) pasó en stage: siete controles renderizados y tres renovaciones, con tokens de 900 segundos. La inspección de Environment en Dokploy del 2026-09-17 no muestra `JWT__AccessTokenMinutes` en la Application API de stage |
| [TK-518](https://github.com/lucasidev/plan-b/issues/518) · 2 | **Volver a la reseña desde cualquier dispositivo** (L10, US-229): el destino de retorno viaja en el link del mail de verificación, saneado como hoy. Listo cuando: el link abierto en un contexto sin cookies termina en la reseña, y la spec de Lucía entra por ese link. | 3 | Hecho en código: registro y reenvío incluyen el destino saneado en el mail; el login conserva materia y cátedra incluso al abrirlo sin cookies. 18 tests HTTP y los 6 E2E de registro y reenvío pasan; Lucía usa el link completo del mail. Lucía abrió el link del mail sin cookies y volvió a Reseñar en stage `097a1725` ([aceptación](../history/reviews/2026-09-17-r7-stage.md)) |
| [TK-519](https://github.com/lucasidev/plan-b/issues/519) · 3 | **La cobertura en la ficha de materia** (V15, US-134): cuántas de sus cátedras publican y cuántas faltan, con la regla de la ficha de carrera; el dato ya está en el read model. Listo cuando: la ficha de 211 lo dice y el recorrido de Valentina lo lee. | 2 | Hecho: la ficha cuenta las cátedras que publican y las que siguen bajo el piso; el componente cubre vacíos y plurales, y Valentina verifica 2 de 3 en la materia 211 |
| [TK-520](https://github.com/lucasidev/plan-b/issues/520) · 4 | **Editar** (L09, US-165): el botón de Mis aportes, el glosario y la spec de Lucía. Listo cuando: Mis aportes dice Editar en el stage y check-docs pasa. | 1 | Hecho: Editar en Mis aportes, el editor ("Guardar los cambios"), la confirmación de envío, Método, el About y la FAQ; el glosario incorpora "Editar una reseña" y desambigua "corregir"; `undo.spec.ts` en verde contra el stack local |
| [TK-521](https://github.com/lucasidev/plan-b/issues/521) · 5 | **El nombre del docente como se tipeó** (P01, US-196): `Teacher` guarda el nombre tal cual, salvo trim; la búsqueda conserva su normalización por minúsculas y acentos, y las lecturas no lo transforman. Una migración conserva el display que ya publicaban las filas legacy en minúsculas, sin recuperar un casing original perdido. Listo cuando: el backoffice y la ficha muestran "Sergio Ruiz" igual, "De Stage" no sale "Destage", y la spec de Copas compara sin ignorar mayúsculas. | 3 | Hecho en código: create, edición, admin, ficha y búsqueda conservan el nombre exacto; la migración prueba filas legacy y mixed-case sin cambiar la búsqueda; Copas aserta "Sergio Ruiz" y el nombre nuevo exactos; 47 tests de integración focales en verde. Los tres casos de Copas pasaron sobre stage `097a1725`, incluido el nombre exacto en backoffice y ficha ([aceptación](../history/reviews/2026-09-17-r7-stage.md)) |
| [TK-522](https://github.com/lucasidev/plan-b/issues/522) · 6 | **Valentina mira la fama, la comparación, el corte y el piso**: la spec verifica la fama en Ibáñez, "Comparada con las otras cátedras" en Pérez, el corte de serie en Aráoz y la cátedra a una del piso (Bravo); V16 queda descartado con esa evidencia. Listo cuando: `just walk valentina` da cumple en esos cuatro pasos sobre el stage recién sembrado. | 1 | Hecho en stage recién sembrado: fama, comparación 56 % contra 0 % sobre 16 y 12 voces, corte de serie y Bravo a una del piso, comprobados por Valentina el 2026-09-17 ([evidencia](../history/reviews/2026-09-17-r7-demo-ready.md)). |
| [TK-527](https://github.com/lucasidev/plan-b/issues/527) · 12 | **Mi perfil sin los campos de la versión anterior** (T01): sacar Legajo, Año cursando y Estado, que ningún doc pide y [ADR-0086](../decisions/0086-the-product-informs-it-does-not-track-your-degree.md) retira de espíritu; el año de ingreso se queda. Listo cuando: Mi perfil muestra solo lo que SC-019 describe y los tests del formulario pasan. | 2 | Hecho en la pantalla: se retiran Legajo, Año cursando y Estado de vista, edición, tipo y payload del formulario. Año de ingreso permanece; el nombre se guarda sin enviar campos retirados. Tests de formulario y suite frontend en verde |

### Pista 2 · El diseño (13 pts)

| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-536](https://github.com/lucasidev/plan-b/issues/536) · 7 | **El catálogo adentro de planb**: la maqueta aprobada el 2026-09-13 pone el catálogo y las fichas adentro de la aplicación, con un solo shell para leer sin cuenta y para reseñar con ella (Explorar ⌘1, Mis aportes ⌘2, Otros: Método, Ajustes, Ayuda, Sobre plan-b). Inicio se funde en Mis aportes, que suma "Tu reseña la publica" y el plan de la carrera de la cuenta, con Editar y Borrar distinguibles; Explorar con las lentes Universidades y Carreras (por carrera canónica) y "Lo que los datos dicen"; las cuatro fichas con datos oficiales en lenguaje de lector, el plan por año adentro de la carrera y una conclusión por cátedra en la materia; "reseñas" cuando se cuenta gente y "voces" solo como denominador. Reemplaza a #523 y #524. Listo cuando: el stage del jueves muestra el shell unificado, las dos lentes, las cuatro fichas y Mis aportes como la maqueta, con CI verde y los recorridos de Valentina y Lucía adaptados. | 13 | Hecho el 2026-09-15 en el código: el shell unificado, las dos lentes, las cuatro fichas y Mis aportes según la maqueta; además, cinco carreras más con su plan tal como lo publica cada universidad ([ADR-0097](../decisions/0097-a-subject-records-only-what-its-official-source-publishes.md)) y reseñas de demostración en veinte cátedras de esas carreras. Verificado en stage: Lucía antes del reset, y Valentina sobre las 390 reseñas del corpus recién sembrado ([evidencia](../history/reviews/2026-09-17-r7-demo-ready.md)) |
| [TK-523](https://github.com/lucasidev/plan-b/issues/523) · 8 | **La revisión del design system**: reemplazada por el rediseño de #536, que rehace las mismas pantallas contra la maqueta aprobada. | 0 | Reemplazada |
| [TK-524](https://github.com/lucasidev/plan-b/issues/524) · 9 | **Los tokens del boletín**: reemplazada por #536; la paleta Apricot se retira con las pantallas que la usaban, y lo que quede fuera del rediseño vuelve a la lista de trabajo técnico pendiente. | 0 | Reemplazada |

### Pista 3 · La demo y lo que la bloquea (8 pts)

| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-525](https://github.com/lucasidev/plan-b/issues/525) · 10 | **Las fallas intermitentes después de un click en el shell**: `admin/terms` ([#510](https://github.com/lucasidev/plan-b/issues/510)), `e2e/settings/settings.spec.ts:40` (Ajustes), `e2e/help/help.spec.ts:27` (Ayuda) y `e2e/reviews/write-review.spec.ts` (Escribir reseña), todas con la misma firma: un click en un link del shell justo después de entrar y la URL que no cambia nunca; el 2026-09-14 frenaron dos veces el deploy de `main`. La traza de la corrida real de CI mostró el mecanismo (una ráfaga de prefetch de los links de la pantalla 223 ms antes del click, el RSC del destino respondiendo 200 y el router de Next 15.5 sin aplicar la navegación, la familia de [TK-477](https://github.com/lucasidev/plan-b/issues/477) y [TK-491](https://github.com/lucasidev/plan-b/issues/491)); en local no reprodujo (0 de 660 corridas con carga). Los links del shell y, desde el 2026-09-15, los del catálogo y Mis aportes (`FallbackLink`) hacen ahora lo que ya hacían los formularios: si a los 2 segundos del click la URL sigue en origen, navegación completa a destino. La lección está en `lessons-learned.md` (2026-09-14). Listo cuando: doce corridas seguidas de los cuatro specs sin la firma en CI. | 3 | Arreglo implementado; la traza del PR #548 confirma recuperación por documento a los cuatro segundos. Ajustes y Ayuda registran ese modo sin rechazarlo, con un E2E que fuerza la recuperación. [Doce corridas verdes verificadas en `main`](../history/reviews/2026-09-17-r7-navigation-ci.md), incluida la corrida 35237465763 de `097a1725`: criterio cumplido el 2026-09-17 |
| [TK-526](https://github.com/lucasidev/plan-b/issues/526) · 11 | **La regla y el jueves** (P02): en el runbook, los recorridos con cuenta corren antes del reset y nunca sobre el stage que se muestra; el jueves a la tarde, reset y seed, la importación de la AGN desde el backoffice y una pasada de los recorridos sin cuenta. Listo cuando: el runbook lo dice y el stage del viernes arranca sembrado: Ruiz en 6, Bravo en 9, Ibáñez con fama, Método sin frases de prueba. | 1 | Hecho el 2026-09-17: reset autorizado de los datos de prueba, seed de 390 reseñas y AGN importada para 5 instituciones; Ruiz en 6, Bravo en 9 y Método limpio. Sofía se clasifica entre los recorridos que escriben ([evidencia](../history/reviews/2026-09-17-r7-demo-ready.md)) |
| [TK-528](https://github.com/lucasidev/plan-b/issues/528) · 13 | **El guion de la demo**: un doc en `docs/plan/` con el camino exacto (la entrada, la carrera y Dónde estudiarla, la materia 211, la fama en Ibáñez, la comparación en Pérez, el corte en Aráoz, Ruiz bajo el piso y Bravo a una, Método; la cuenta, la reseña, Mis aportes, Editar y Borrar; el backoffice con la cátedra y la destilada), con las URL, las cuentas de prueba y el checklist previo (reset, seed, AGN, Mailpit y el SHA que se muestra; tag narrativo opcional). Listo cuando: el guion se camina de punta a punta sobre el stage del jueves sin sorpresas. | 1 | Hecho el 2026-09-17: recorridos con escritura verificados antes del reset, lectura pública y backoffice después. Corpus limpio y AGN importada; evidencias finales integradas en [#555](https://github.com/lucasidev/plan-b/pull/555) ([preparación](../history/reviews/2026-09-17-r7-demo-ready.md)). El SHA verificado queda registrado y el tag es opcional |
| [TK-529](https://github.com/lucasidev/plan-b/issues/529) · 14 | **La tesis y los docs dicen lo que hay** (T01 a T08 de [la revisión](../history/reviews/2026-09-13-thesis-and-docs-vs-product.md)): la cabecera de la tesis sin la poda pendiente y con el puntero al mapa como estado; el glosario corregido; las cuatro fichas con slug viejo y SC-031; SC-029 y SC-027 diciendo que describen el destino; y `.agents/skills/README.md` diciendo dónde viven los skills. Listo cuando: check-docs pasa y el registro tiene cada hallazgo resuelto con el commit. | 3 | Hecho el 2026-09-14 en la rama del catálogo (T02 a T08); T01 queda resuelto en la pantalla al retirar los tres campos de Mi perfil (#527) |
...
| Tarea 11 | P02, T09 |
| Tareas 12 y 14 | T01 |
| Tarea 14 | T02 (la tesis apunta al mapa), T03, T04, T05, T06, T07, T08 |
...
La 7 corre de lunes a jueves en dos PR: el shell, Explorar y Mis aportes el miércoles a la mañana, las cuatro fichas el jueves a la mañana. Lunes: 1, 3, 4, 6 y 12. Martes: 2, 5 y 14. Miércoles: 10. Jueves: 11 y 13, y nada de código nuevo después del mediodía: reset y seed, la AGN, el SHA registrado y el guion caminado. Viernes: la demo.
...
6. El catálogo y las fichas adentro del shell de planb, con las dos lentes de Explorar, las cuatro fichas y Mis aportes como la maqueta aprobada.
7. Doce corridas de `admin/terms` sin la firma, y el deploy del jueves sin relanzar nada.
8. El jueves, el stage sembrado, la AGN importada, el SHA registrado y el guion caminado; el tag narrativo es opcional.
...
### Recuperación de los worktrees del 2026-09-18

Los cinco worktrees se recuperaron sobre main posterior a #569, conservando las migraciones de seguridad y la navegación del catálogo. La rama incluye TK-530, TK-531, TK-532 y la cobertura pendiente de TK-533. Los originales se conservan hasta completar la integración. El catálogo nacional se importa manualmente: mergear y desplegar no ejecuta la importación. La ampliación del modelo de cátedras sigue en los lotes de abajo. La [corrida CI de recuperación](https://github.com/lucasidev/plan-b/actions/runs/35411979456) aprobó unitarios, 890 pruebas de integración, frontend, E2E y Lighthouse; tooling reutilizó el resultado vigente porque sus entradas no cambiaron.

### Tareas del plan base (36 pts)

| # | Tarea | Pts | Estado |
|---|---|---|---|
| [TK-530](https://github.com/lucasidev/plan-b/issues/530) · 1 | **Crear las cuentas del corpus en identity** (datos): el seed crea las cuentas del corpus, hoy ids sueltos del rango `00000020-…`; no tiene una story propia porque corrige la coherencia interna de datos de prueba. Miembros verificados, con perfil en el plan de la carrera que reseñan, fecha de registro anterior a su reseña y repartida en el tiempo, mail con forma real en un dominio reservado y sin contraseña usable; las reseñas quedan atadas a esas cuentas y `dev-seed-personas.md` documenta el conjunto. Listo cuando: `seed-db` sobre una base vacía deja cada reseña con su cuenta existente, los conteos de las fichas no cambian y ninguna cuenta del corpus puede iniciar sesión. | 5 | Recuperado en rama de integración: cuentas sintéticas protegidas contra reactivación administrativa; CI verde en PR #570, merge pendiente |
| [TK-531](https://github.com/lucasidev/plan-b/issues/531) · 2 | **Importar el catálogo nacional desde la Guía SIU** (datos): implementa [US-222](../product/student/choose-where-to-study/stories/US-222-browse-what-there-is-to-study/README.md), [US-128](../product/student/choose-where-to-study/stories/US-128-compare-the-same-career-side-by-side/README.md), [US-132](../product/student/choose-where-to-study/stories/US-132-search-by-subject-career-or-teacher/README.md) y sostiene [US-234](../product/team/sustain-the-catalog/stories/US-234-maintain-a-complete-institution/README.md). Importa instituciones, sedes, unidades académicas, ofertas, tipo, duración en el papel y régimen de ingreso; Georef resuelve la localidad de cada sede y el anuario SPU aporta la identidad institucional. Empieza por congelar la fuente y sus términos. Listo cuando: el stage lista las instituciones del país con sus ofertas, cada ficha dice qué dato tiene y cuál no, Dónde estudiarla agrupa fuera de Tucumán y el seed tucumano no cambia sus números. | 13 | Recuperado en rama de integración: captura nacional y comando de importación; CI verde en PR #570, merge e importación operativa en stage pendientes |
| [TK-532](https://github.com/lucasidev/plan-b/issues/532) · 3 | **Mantener y publicar una institución completa** (implementación): implementa [US-234](../product/team/sustain-the-catalog/stories/US-234-maintain-a-complete-institution/README.md), [US-235](../product/student/choose-where-to-study/stories/US-235-see-who-and-where-the-institution-is/README.md) y completa la fuente editorial de [US-232](../product/student/choose-where-to-study/stories/US-232-see-what-the-institution-publishes/README.md). Incluye identidad, ubicación, dominios, unidades académicas, conteos derivados y afirmaciones oficiales desde el backoffice; la ficha pública muestra logo, URL y ubicación. El mecanismo del logo se decide antes de implementar. Listo cuando: Sofía carga una institución entera sin tocar el seed y una persona sin cuenta ve su identidad y ubicación correctas. | 13 | Recuperado en rama de integración: backend, migración y editor institucional; CI y recorrido backoffice a ficha pública sin sesión verdes en PR #570, merge pendiente |
| [TK-533](https://github.com/lucasidev/plan-b/issues/533) · 4 | **Capturar modalidad y cantidad de cursadas** (implementación): implementa [US-233](../product/student/write-a-review/stories/US-233-share-private-course-context/README.md) y [ADR-0082](../decisions/0082-the-review-captures-the-cursada-in-three-layers.md) §3. El formulario las pide como contexto privado, el dominio y el seed las llevan y ningún read público las expone. Listo cuando: se pueden responder o saltear, una opción inválida se rechaza y `check-scenarios` cubre US-233. | 3 | Recuperado en rama de integración: pruebas de persistencia, opciones y privacidad sobre el formulario vigente; CI verde en PR #570, merge pendiente |
| [TK-534](https://github.com/lucasidev/plan-b/issues/534) · 5 | **Retirar el rol sin cliente** (poda): `UniversityStaff` sale del enum y del glosario; `Moderator` se queda. No tiene story porque elimina una capacidad sin persona ni cliente. Listo cuando: enum, glosario, datos y tests coinciden y ningún dato del stage referencia el rol retirado. | 2 | Integrado mediante PR #565; migración publicada en stage el 2026-09-18 |
...
**0. Consolidar lo ya construido.** Estado: integrado mediante PR #566. Alcance: US-198, US-199 y [US-236](../product/team/cut-the-access/stories/US-236-manage-student-accounts/README.md).
...
- **Los tokens del boletín en `globals.css`**: hoy sigue la paleta Apricot sirviendo al chasis en retiro ([ADR-0071](../decisions/0071-the-visual-language-is-a-bulletin.md)); el rediseño del catálogo (#536) retira lo que tocan sus pantallas, y lo que quede afuera vuelve acá con nombre.
