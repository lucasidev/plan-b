...
| Hi-fi | `screens/<screen>/sketch.html` de las pantallas clave | Aplican este contrato (el mid-fi queda en git). |
| Mid-fi | [`screens/`](screens/README.md) y `docs/epics/*/screens/` | Estructura y estados; paleta anterior, a propósito. |
