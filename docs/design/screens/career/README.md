...
> Ficha de pantalla compartida ([inventario](../README.md)). **Estado**: borrador escrito el 2026-08-19 con su [boceto mid-fi](sketch.html) de la cabecera con gate, la trayectoria y la co-cursada pública; revisada el 2026-08-19 ([registro](../../../reviews/2026-08-19-shared-screens.md)); **hi-fi en la dirección Boletín** ([ADR-0071](../../../decisions/0071-the-visual-language-is-a-bulletin.md), 2026-08-19; el mid-fi quedó en git). Pública, se lee sin cuenta. Sin slug propio hoy (lo más cercano en el código: `/careers/[id]/plans`, del inventario). Épicas que la componen: [Elegir dónde estudiar](../../../epics/choose-where-to-study/README.md) (la cabecera con su gate, las listas por eje, la trayectoria, la ficha vacía y de qué voces está hecha), [Mi carrera](../../../epics/my-career/README.md) (el plan con sus materias, la co-cursada pública), [Pedir una carrera](../../../epics/request-a-career/README.md) (el vacío explicado cuando la carrera todavía no está cargada) y [Llevarse el dato](../../../epics/take-the-data/README.md) (el CSV y Método salen de lo que esta ficha publica).
