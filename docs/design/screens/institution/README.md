...
> Ficha de pantalla compartida ([inventario](../README.md)). **Estado**: borrador escrito el 2026-08-19 con su [boceto mid-fi](sketch.html) de las tres cosas que no se mezclan, la serie y la comparación; revisión adversarial pendiente antes del hi-fi. Pública, se lee sin cuenta. Slug hoy `/universities/[slug]` (del inventario). Épicas que la componen: [Elegir dónde estudiar](../../../epics/choose-where-to-study/README.md) (la lectura: qué se dice de ella como sujeto, la serie, la comparación frase por frase), [Replicar](../../../epics/reply/README.md) (la réplica institucional al lado del testimonio del evento) y [Reseñar](../../../epics/write-a-review/README.md) (el evento institucional llega acá).
