...
| [`engineering/`](engineering) | **¿cómo está construido?** | El [modelo de datos](engineering/data-model.md), las [claves de Redis](engineering/redis-key-patterns.md), las [convenciones de testing](engineering/testing.md), las convenciones de [backend](engineering/backend-conventions.md) y [frontend](engineering/frontend-conventions.md) y los playbooks: [git](engineering/git-workflow.md), [rollback](engineering/rollback.md), [deploy](engineering/deploy.md), [lecciones](engineering/lessons-learned.md). |
...
Una **épica** es lo que alguien viene a hacer: Reseñar, Responder, Moderar. Son catorce, y cada una contiene **todo lo suyo**, cortado en vertical:
...
└── write-a-review/                          una carpeta por épica
    ...
    ├── stories/
    │   ├── US-146-review-in-under-five-minutes/
