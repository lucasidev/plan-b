...
| Tramo | Grupo del mapa | Persona que lo pide | Stories | Pantallas |
|---|---|---|---|---|
| [Sostener el catálogo](team/sustain-the-catalog/README.md) | BO1 (+ US-200/2/3/5, US-204) | Sofía, quien cura las preguntas | 16 | 5 |
...
| `SC-029` |  | [Preguntas](team/sustain-the-catalog/screens/SC-029-phrases/README.md) | `/admin/items` |
...
- **Los números salen de [ADR-0083](../decisions/0083-the-ficha-publishes-counts-not-scores.md)**: la moda y la distribución son conteos crudos con su denominador (quienes respondieron esa pregunta), y las comparaciones usan intervalos de Wilson como maquinaria interna para decidir qué se publica (el ADR fija la regla de intervalos; el valor de z lo fija el código, no un ADR). La tercera es de [ADR-0082](../decisions/0082-the-review-captures-the-cursada-in-three-layers.md): una persona suma una voz por cursada. Sin esos tres, ningún dato publicado se puede recalcular dos veces igual.
