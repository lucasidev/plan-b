# US-199: Revisar preguntas destiladas antes de ofrecerlas
...
Cuando quien cura las preguntas abre la cola de curaduría en Preguntas.
...
Cuando quien cura las preguntas lo aprueba asignándole capa "qué hizo la cátedra", opciones "Sí · A veces · Nunca" y código I48, y confirma "Confirmar y marcar como destilado".
Entonces recién ahí queda disponible para responder al reseñar una cátedra, ofrecida como pregunta destilada.
...
Cuando Lucía reseña "Análisis Matemático II, Cátedra Pérez" (UNSTA) y ve las preguntas disponibles para responder.
Entonces "Tardan semanas en devolver la nota" no aparece entre las preguntas que puede responder: no se ofrece hasta que se apruebe.

**N2.** Dado que quien cura las preguntas descarta el candidato "Tardan semanas en devolver la nota" en vez de aprobarlo.
Cuando alguien busca ese candidato después, en Preguntas o en cualquier ficha pública.
...
- El piso de 10 reseñas por cátedra ([ADR-0082](../../../../../decisions/0082-the-review-captures-the-cursada-in-three-layers.md)) es sobre la cátedra entera, no por pregunta: una pregunta recién aprobada puede tener solo 1 o 3 voces mientras la cátedra ya pasó el piso general y publica el resto de sus conteos.
