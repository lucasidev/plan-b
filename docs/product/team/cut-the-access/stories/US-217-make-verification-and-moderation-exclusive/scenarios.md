...
**E3.** Dado que el registro guarda, por separado, la acción de Camila aprobando la constancia de un alumno (con su nombre real) y la acción de Nahuel leyendo el campo libre de esa misma cátedra para destilar una pregunta
