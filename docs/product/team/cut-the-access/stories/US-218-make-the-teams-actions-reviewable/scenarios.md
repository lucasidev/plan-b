...
**E1.** Dado que en agosto de 2026 la curaduría publicó 2 notas editoriales y retiró 1, aprobó 3 preguntas destiladas y descartó 5, y resolvió 2 reclamos de instituciones sobre datos publicados (1 corrigió el catálogo, 1 se sostuvo)
...
- Un mes sin ninguna nota, ninguna pregunta destilada y ningún reclamo: el registro público muestra el agregado en cero, la sección no desaparece.
