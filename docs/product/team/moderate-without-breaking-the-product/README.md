...
| ID | De qué trata |
|---|---|
| [US-205](stories/US-205-moderate-without-removing-the-complaint/README.md) | Bajar solo lo que expone a alguien |
| [US-206](stories/US-206-notify-the-reporter-of-the-outcome/README.md) | Avisar por qué se resolvió un reporte |
...
| [US-209](stories/US-209-review-what-was-held-back/README.md) | Revisar lo que el chequeo retuvo |
...
| [US-212](stories/US-212-show-the-moderation-queue-under-backlog/README.md) | Mostrar la cola de moderación desbordada |
| [US-213](stories/US-213-flag-correlated-accounts-by-provenance/README.md) | Alertar cuentas correlacionadas por procedencia |
| [US-214](stories/US-214-group-reports-by-target-and-window/README.md) | Agrupar reportes por objetivo y ventana |
...
Las que comparte con otras épicas: **Anonimato** y **Método** (donde la política de moderación y réplica se publica, en [Llevarse el dato](../../student/take-the-data/README.md)), y la [Ficha de cátedra](../../student/choose-where-to-study/screens/SC-002-chair/README.md) (el texto retirado con su categoría).
