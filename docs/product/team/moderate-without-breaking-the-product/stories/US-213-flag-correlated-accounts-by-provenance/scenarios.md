...
**E1.** Dado que 15 cuentas se dieron de alta el mismo día, respondiendo igual en cada pregunta entre ellas y sin ninguna trayectoria previa (ninguna había reseñado nada antes), y las 15 responden la pregunta "Podían preguntar sin quedar mal" con la misma opción sobre Cátedra Pérez dentro de una ventana de 2 horas.
...
Cuando se recalcula esa pregunta sobre Cátedra Pérez.
Entonces esas 15 voces no suman ni a las voces ni a la moda de esa pregunta, ni a ningún agregado de trayectoria de esas cuentas.
