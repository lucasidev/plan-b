...
**Decisión que produce**: por ella se responden preguntas cerradas en vez de escribir, la unidad es una cursada y no el período, y lo único que la reseña le agrega es un toque: cómo terminó. Y la co-cursada que le sirve sale sola de las reseñas, sin que el producto le pida nada de su carrera ([ADR-0086](../decisions/0086-the-product-informs-it-does-not-track-your-degree.md)).
...
**Decisión que produce**: por él el gate llega en la acción y no en la puerta, nada le pide completar algo antes de reseñar, y su reseña queda: suma a los conteos, y si escribe en el campo libre, alimenta las preguntas que se destilan más adelante. Lo que quiere es que quede.
...
**Decisión que produce**: por ella el método es público (la regla de comparación, el catálogo de preguntas, los sesgos), la cobertura se declara y el crudo se descarga sin registro, agregado por pregunta con voces y período, sin reseñas individuales: no existe un crudo con más que la ficha.
