...
| ID | De qué trata |
|---|---|
| [US-139](stories/US-139-tell-apart-the-three-empty-states.md) | Distinguir si el vacío es del producto o de la facultad |
| [US-140](stories/US-140-request-a-career-without-an-account.md) | Pedir la carga de una carrera sin registrarse |
