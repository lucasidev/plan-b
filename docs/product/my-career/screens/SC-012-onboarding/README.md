...
US-145 (marcar por dónde vas es la preferencia privada que después arma el paso siguiente, en papel: el producto no arma horarios), US-170 (salteable: todo funciona sin plan marcado, salvo lo que necesita saber qué cursás), US-169 (nada de lo que la cuenta ya declaró se vuelve a preguntar acá). La letra de cada una: [README de la épica](../../README.md) y de [Que no me molesten](../../../do-not-bother-me/README.md#stories).
