...
La intención no cambió (no me hagan hacer trámites); cambió el sujeto, de un trámite que ya no existe a cualquiera que se agregue. Ahora agarra los dos casos que la versión anterior no nombraba: un paso obligatorio antes de dejarte contar una cursada, y un gate de cuenta para leer una ficha (que además viola [US-168](../US-168-read-without-an-account/README.md)).
