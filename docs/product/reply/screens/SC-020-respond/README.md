...
[US-227](../../stories/US-227-claim-an-institutional-position-to-reply.md) (sin cargo verificado no hay campo de respuesta, y la réplica se firma con nombre y cargo).
## Qué muestra
