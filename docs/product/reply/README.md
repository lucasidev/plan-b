...
| ID | De qué trata |
|---|---|
| [US-227](stories/US-227-claim-an-institutional-position-to-reply.md) | Pedir que verifiquen mi cargo antes de responder |
| [US-172](stories/US-172-reply-with-a-verified-identity.md) | Responder con identidad verificada |
| [US-173](stories/US-173-show-two-axes-without-a-score.md) | Mostrar los dos ejes sin puntaje |
| [US-174](stories/US-174-compare-institutions-side-by-side.md) | Comparar instituciones lado a lado |
| [US-175](stories/US-175-notify-mentions-without-timestamps.md) | Avisar al docente que lo nombraron |
| [US-176](stories/US-176-declare-channel-state-never-silence.md) | Declarar el estado del canal |
| [US-177](stories/US-177-track-change-across-periods.md) | Ver la serie por período |
| [US-178](stories/US-178-verify-identity-before-replying.md) | Verificar identidad antes de responder |
| [US-179](stories/US-179-withhold-the-reply-until-author-responds.md) | No quedar expuesto por la réplica |
