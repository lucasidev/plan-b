...
Quien ya aportó (Matías, Lucía, Diego): quiere poder sacar lo que dijo antes de que le pese. Quien lee, incluido el que una reseña difama sin nombrarlo: puede reportar sin registrarse en el sitio que lo difama (US-167).
...
| ID | De qué trata |
|---|---|
| [US-165](stories/US-165-edit-or-delete-what-i-said.md) | Editar o borrar un aporte propio |
| [US-166](stories/US-166-delete-my-account-anonymized-not-erased.md) | Dar de baja la cuenta y preservar el corpus anonimizado |
| [US-167](stories/US-167-report-content-without-an-account.md) | Reportar contenido publicado sin registrarse |
