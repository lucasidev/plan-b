...
Qué lentes y qué orden ofrece Explorar; cómo se lee la trayectoria sin vocabulario (US-133); el layout de Dónde estudiarla en celular con muchas ofertas; qué muestra la Ficha de institución además de la serie y la comparación frase por frase (US-174, US-177, en [Replicar](../reply/README.md)).
