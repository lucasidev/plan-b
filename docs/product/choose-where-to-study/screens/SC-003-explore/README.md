...
[US-171](../../../do-not-bother-me/README.md#stories) (nunca un puntaje ni un orden por conveniencia; alfabético o por voces), [US-139](../../../request-a-career/README.md#stories) (el vacío se explica en tres estados y ninguno es un cero), [US-168](../../../do-not-bother-me/README.md#stories) (sin cuenta).


[US-222](../../stories/US-222-browse-what-there-is-to-study.md) (la razón de que esta pantalla exista: ver qué hay para estudiar sin tener un nombre que buscar).
## Qué muestra
