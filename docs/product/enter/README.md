...
Esta épica aporta a pantallas de otras: nada. Al revés sí: [Reseñar](../write-a-review/README.md), [Cuidar lo publicado](../care-for-what-is-published/README.md), [Replicar](../reply/README.md) y [Pedir una carrera](../request-a-career/README.md) disparan el umbral desde sus acciones, y cada uno lo dice en su README.
