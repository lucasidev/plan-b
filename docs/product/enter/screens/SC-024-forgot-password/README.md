...
No tiene un requisito con ID propio en el catálogo vigente: es la garantía que describe el texto de [Que no me molesten](../../../do-not-bother-me/README.md) (antes numerada O5-3; hoy no tiene fila en ninguna tabla de requisitos): "recuperar la contraseña, con la cuenta y todo lo que tiene adentro, vuelve con un link al mail". Comparte el espíritu de [US-169](../../../do-not-bother-me/README.md#stories): nada de lo declarado se pierde ni se vuelve a preguntar.


[US-220](../../stories/US-220-recover-the-password-by-mail.md) (recuperar la contraseña con un link al mail: los dos pasos y sus dos estados viven acá).
## Qué muestra
...
[Que no me molesten](../../../do-not-bother-me/README.md) (la garantía, dicha en su propio texto), [THESIS.md](../../../../THESIS.md) (decisión 3: producir pide cuenta, y esta pantalla sostiene esa cuenta sin fricción).
