...
- [Verificar](../../care-for-what-is-published/screens/SC-022-verify/README.md): el camino de identidad docente, con el aviso de que se compara contra lo que el catálogo ya sabe de esa cátedra.
- [Responder](../../reply/screens/SC-020-respond/README.md): sin identidad verificada, en vez del campo de respuesta hay un aviso para ir primero a Verificar.
