...
Llega desde el **Reportar** de cualquier ficha pública (acción inline sin cuenta, épica [Deshacer](../../../undo/README.md), US-167) y desde lo que el chequeo previo retiene al publicarse en [Reseñar](../../../write-a-review/README.md) o [Responder](../../../reply/README.md) (ADR-0068 punto 5). Al resolver, el criterio aplicado va al mail de quien reportó; un texto bajado se ve como retirado en la ficha pública ([Ficha de cátedra](../../../choose-where-to-study/screens/SC-002-chair/README.md)). No tiene "siguiente pantalla": vuelve a la cola.
