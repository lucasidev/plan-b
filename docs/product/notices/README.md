...
Sus destinos son pantallas de otras épicas: [Reseñar](../student/write-a-review/README.md) y [Mi situación](../student/write-a-review/screens/SC-014-my-status/README.md) (las dos de Reseñar), [Responder](../reviewed/reply/README.md) y Empezar (de Mi carrera, cuando alguien se registra por primera vez desde "cargamos lo que pediste"). Donde cada aviso se apaga, [**Mi perfil**](../student/undo/screens/SC-019-my-profile/README.md).
