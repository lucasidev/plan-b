...
| **Marcar el plan** | Señalar en tu plan qué materias te faltan o considerás. Es **preferencia privada, no dato**: no se recaba, no se publica, no entra a ningún agregado ([ADR-0069](../decisions/0069-the-marked-plan-is-a-private-preference-not-a-fact.md)). |
