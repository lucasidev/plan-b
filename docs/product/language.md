...
| **Editar** | Cambiar una reseña propia desde Mis aportes: entera o una respuesta de a una; lo que cambia mueve los conteos de la ficha en el acto. Deshacerla entera es **borrar**, que pide confirmación (US-165). |
...
| **corregir** | "Cambiar lo que dije en una reseña" | Eso se dice **editar**. Corregir queda para un dato duro de una ficha ([US-189](student/care-for-what-is-published/stories/US-189-correct-a-hard-fact-inline/README.md)). |
