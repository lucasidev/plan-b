...
Es el par de [US-178](../US-178-verify-identity-before-replying/README.md) para el cargo institucional: esa cubre al docente y esta a quien responde por la institución. Faltaba, y por eso dos stories de esta épica ([US-172](../US-172-reply-with-a-verified-identity/README.md) y [US-174](../US-174-compare-institutions-side-by-side/README.md)) asumían una réplica institucional que nadie podía habilitar.
