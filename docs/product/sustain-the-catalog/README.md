...
| ID | De qué trata |
|---|---|
| [US-191](stories/US-191-load-the-full-catalog-by-gaps.md) | Ver qué falta antes de lo cargado |
| [US-192](stories/US-192-order-the-queue-by-demand.md) | Ordenar la cola por demanda |
| [US-193](stories/US-193-notify-requesters-when-loaded.md) | Avisar a quienes esperaban al terminar |
| [US-194](stories/US-194-check-a-correction-against-the-source.md) | Contrastar la corrección contra la fuente |
| [US-195](stories/US-195-declare-offerings-as-the-same-career.md) | Declarar dos ofertas como la misma carrera |
| [US-196](stories/US-196-load-the-chair-as-teaching-staff.md) | Cargar la cátedra como entidad propia |
| [US-197](stories/US-197-link-declared-subjects-to-canonical.md) | Vincular materias declaradas a la canónica |
| [US-198](stories/US-198-curate-a-phrase-in-one-place.md) | Editar la frase en un solo lugar |
| [US-199](stories/US-199-review-distilled-phrases-before-marking.md) | Revisar frases destiladas antes de ofrecerlas |
| [US-200](stories/US-200-show-the-queue-throughput-and-overflow.md) | Mostrar el ritmo real de la cola |
| [US-201](stories/US-201-edit-a-published-offering-and-notify.md) | Corregir una oferta ya publicada |
| [US-202](stories/US-202-mark-a-field-as-unofficial-source.md) | Cargar con una fuente no oficial |
| [US-203](stories/US-203-seed-the-queue-on-day-one.md) | Decidir qué cargar el primer día |
| [US-204](stories/US-204-survive-a-curriculum-reform.md) | Que la reforma no parta el corpus |
| [US-224](stories/US-224-normalize-institutional-position.md) | Normalizar el cargo institucional |
...
- [**Frases**](screens/SC-029-phrases/README.md) (backoffice): el catálogo de frases con su redacción, sujeto y eje, y la cola de curaduría de las destiladas; [boceto mid-fi](screens/SC-029-phrases/sketch.html).

Las que comparte con otras épicas: la [Ficha de cátedra](../choose-where-to-study/screens/SC-002-chair/README.md) (de donde llega una corrección) y la [Ficha de materia](../choose-where-to-study/screens/SC-007-subject/README.md) (a donde va lo cargado), [**Dónde estudiarla**](../choose-where-to-study/screens/SC-008-where-to-study/README.md) (usa la carrera canónica que acá se declara), [**La cola**](../request-a-career/screens/SC-009-queue/README.md) (la vista pública de Pedidos, en [Pedir una carrera](../request-a-career/README.md)), [**Método**](../take-the-data/screens/SC-021-method/README.md) (publica el catálogo de frases entero, en [Llevarse el dato](../take-the-data/README.md)) y los mails de [Avisos](../notices/README.md) (el aviso al terminar de cargar una oferta).
