...
**E1.** Dado que en la Cátedra Pérez, con 40 voces, 24 respondieron "Casi nunca" en "¿Salías de la clase entendiendo el tema?" (pregunta I09, capa vivencia)
...
**E2.** Dado que el catálogo tiene preguntas semilla agrupadas en tres capas (contexto, qué hizo la cátedra, qué te pasó a vos), cada una con su código estable y sus opciones (por ejemplo, I01 "¿Contestaba las preguntas en clase?": Siempre · A veces · Casi nunca · Nadie preguntaba)
Cuando Rocío entra a Método
Entonces ve el catálogo entero, cada pregunta con su capa y sus opciones a la vista, incluida la capa de vivencia al lado de la de conducta observable.
...
Entonces declara que las tres opciones comparten el mismo denominador (las 40 voces que respondieron esa pregunta en esa cursada y período) y que sus conteos suman el total de quienes respondieron, nunca a un juicio aparte; y las tres viajan con sus voces y su período al lado.
...
Cuando se compara ese dato con la misma pregunta dentro de una sola cátedra y un solo período
...
- "¿Tomó temas que no estaban en el programa?" todavía no la respondió nadie en ninguna cursada: igual aparece en el catálogo entero de Método, porque el catálogo se publica completo aunque una pregunta no tenga uso todavía.
