...
| ID | De qué trata |
|---|---|
| [US-188](stories/US-188-vote-me-too-on-a-review/README.md) | Sumar una voz sin escribir |
...
Sus otras dos acciones pasan adentro de pantallas ajenas, a las que esta épica les aporta: [**Mi perfil**](../undo/screens/SC-019-my-profile/README.md) (la señal de verificado se ve ahí, US-190), las acciones inline **Votar** y **Corregir** (adentro de la ficha, sin cambiar de pantalla), la [Ficha de cátedra](../choose-where-to-study/screens/SC-002-chair/README.md) y la [Ficha de materia](../choose-where-to-study/screens/SC-007-subject/README.md) (los testimonios ordenados por votos); en el backoffice, [**Correcciones**](../../team/sustain-the-catalog/screens/SC-028-corrections/README.md) (dueña [Sostener el catálogo](../../team/sustain-the-catalog/README.md)) y [**Verificaciones**](../../team/moderate-without-breaking-the-product/screens/SC-032-verifications/README.md) (dueña [Moderar sin romper el producto](../../team/moderate-without-breaking-the-product/README.md)).
