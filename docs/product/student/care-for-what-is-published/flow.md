...
> No reemplaza ninguna fila del mapa: el mapa dibuja Votar y Corregir como "acciones inline", sin fila de flujo propia. Personas: Matías (vota), quien vuelve (corrige), quien lee (los testimonios), quien ya aportó (se verifica). Disparador: leer una ficha con testimonios o con un dato duro mal cargado. Stories que cubre: US-188, US-189, US-190 (y lo que tocan del otro lado: US-194, US-207, US-208, US-211).
...
flowchart TD
  ...
  C -->|con cuenta| C1([Suma una voz a las frases de esa reseña y reordena, US-188])
