...
flowchart TD
  ...
  E --> E2[Ficha de cátedra: los hechos que la marcan, cómo termina la cursada, qué hizo la cátedra / qué les pasó a los que cursaron, cada pregunta con sus voces, US-129, US-131]
  ...
  C2 --> G[Método: la moda, la distribución, el catálogo de preguntas, el piso y los sesgos, US-130]
...
- [Método](../take-the-data/screens/SC-021-method/README.md): la moda, la distribución, el catálogo de preguntas y los sesgos, dueña de [Llevarse el dato](../take-the-data/README.md) (nodos F2, G).
