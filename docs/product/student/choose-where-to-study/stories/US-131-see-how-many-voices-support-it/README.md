...
- Cada pregunta publicada muestra su propio "de N" (cuántas voces la respondieron), al lado de su moda y de su distribución completa.
- Ninguna proporción se publica sin ese denominador al lado.

## Dónde se resuelve

- [Ficha de cátedra](../../screens/SC-002-chair/README.md): cada pregunta se publica con su moda, su distribución y su "de N" voces.
