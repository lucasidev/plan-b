...
Cuando La entrada arma el bloque de la muestra honesta
...
**E3.** Dado que alguien entra a La entrada desde un link que le compartieron, sin saber qué es plan-b
...
Cuando La entrada arma la muestra honesta
Entonces esa ficha nunca puede salir sorteada: el sorteo excluye a todo lo que no pasó el piso.

## Edge cases

- Si en un momento dado ninguna ficha pasó todavía el piso (producto recién arrancado), qué muestra La entrada no está resuelto en ninguna story ni en la ficha de la pantalla. **Falta decidir**.
...
- Cuánto dura cada ficha en el sorteo (por visita, por día) y si se excluye la que el visitante ya vio: la propia ficha de La entrada lo deja abierto.
