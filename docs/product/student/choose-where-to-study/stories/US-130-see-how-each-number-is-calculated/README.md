...
Como quien está eligiendo, quiero ver cómo calculan cada número, para poder descartarlo con fundamento o citarlo.
...
- Publica el catálogo de preguntas entero, con sus opciones y la capa a la que pertenece cada una (qué hizo la cátedra / qué te pasó a vos).
...
- [Método](../../../take-the-data/screens/SC-021-method/README.md): la moda, la distribución, la regla de comparación entre hermanas, el catálogo de preguntas entero, el piso, la cobertura y los sesgos declarados se publican acá.
