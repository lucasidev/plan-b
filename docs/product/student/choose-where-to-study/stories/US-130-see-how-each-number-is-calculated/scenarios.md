...
**E1.** Dado que Rocío quiere citar en una reunión la pregunta "¿Se dictaron las clases?" de Cátedra Pérez, con moda "Faltaron muchas · 41 %" sobre 37 voces
...
Entonces muestra que un hecho como "Acá no se aprende preguntando" sale de que varias preguntas distintas (salir entendiendo, poder preguntar, que le contesten) apuntan al mismo lado, y que el sustento publicado al lado es la lista de esas preguntas con sus porcentajes, nunca un número que las promedie.
...
**E4.** Dado que el catálogo tiene sus preguntas de contexto, de conducta observable y de vivencia
Cuando se abre el bloque del catálogo en Método
Entonces cada pregunta se lista con sus opciones y la capa a la que pertenece, y hay forma de ver el catálogo entero, no solo una muestra sin salida.
...
- El catálogo todavía no tiene ninguna pregunta destilada del campo libre (solo las semilla): Método publica igual las semilla completas, con la marca "destilado" reservada para cuando exista la primera.
