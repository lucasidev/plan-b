...
**E1.** Dado que en la Ficha de Cátedra Pérez (Análisis Matemático II, UNT) la pregunta "¿Se dictaron las clases?" tiene moda "Faltaron muchas · 41 %" sobre 37 voces, en el bloque "Qué hizo la cátedra"
...
- Una cátedra con preguntas marcadas solo en "qué hizo la cátedra" y ninguna todavía en "qué les pasó a los que cursaron" (o al revés): la lectura que arma quien lee queda con menos ingredientes de un lado, pero ningún bloque se completa ni se infiere para balancearla.
