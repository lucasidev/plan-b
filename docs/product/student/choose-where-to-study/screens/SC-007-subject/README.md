...
2. **Los cuatro números que resumen la materia**: intentos promedio para aprobarla, cuántas materias habilita al aprobarse, cuánto llega a aprobada o regular ("6 de 10") y si se puede rendir libre. Cuando la materia es la que más traba su carrera, lo dice en una línea ("es la materia que más frena esta carrera: la traba de 2,1 intentos alcanza a las 9 materias que la esperan").
