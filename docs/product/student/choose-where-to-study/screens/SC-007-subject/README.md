...
2. **Los números que resumen la materia**: cuántas veces se la cursa antes de aprobarla, cuántas materias habilita al aprobarse, cuánto llega a aprobada o regular ("6 de 10") y si se puede rendir libre. Los intentos van como **distribución y nunca como promedio**: el boceto decía "2,1", pero [ADR-0083](../../../../../decisions/0083-the-ficha-publishes-counts-not-scores.md) descarta esa forma por su nombre, y acá el promedio sería además irreproducible porque la última opción del ítem es abierta ("tres o más"). Lo de rendir libre todavía no tiene fuente (ver Falta decidir), así que la pantalla no lo muestra en vez de inventarlo. Cuando la materia es la que más traba su carrera, lo dice en una línea ("es la materia que más frena esta carrera: la traba de 2,1 intentos alcanza a las 9 materias que la esperan").
