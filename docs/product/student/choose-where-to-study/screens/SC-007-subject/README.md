...
1. **Cabecera**: el eyebrow con el año del plan y la carrera, con link ("Materia · 2º año del plan 2018 · Tecnicatura Universitaria en Desarrollo y Calidad de Software"), el nombre de la materia, la línea de sustento ("28 reseñas en 3 cátedras, de 2024 a 2026. Depende de cuál te toque: acá está cada una por separado.") y la cobertura de sus cátedras ("2 de 3 cátedras con datos publicados. 1 todavía no llega al piso."). La universidad, la carrera y el código van en las migas del topbar: "Explorar / UNSTA / Tecnicatura Universitaria en Desarrollo y Calidad de Software / 211 · Fundamentos de Control de Calidad".
...
- **Alguna cátedra bajo el piso**: la cobertura dice cuántas cátedras ya publican y cuántas todavía no llegan al piso; la fila se lista con su conteo y "todavía sin conclusiones", y no suma a ninguno de los números derivados ni a la dispersión.
