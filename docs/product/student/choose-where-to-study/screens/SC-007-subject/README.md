...
1. **Cabecera**: el eyebrow con la carrera y la universidad (links), el código y el nombre de la materia, y la línea de sustento: "28 reseñas en 3 cátedras, de 2024 a 2026. Depende de cuál te toque."
2. **La tira de números**: reseñas, cátedras (las que juntaron alguna), cuánto llega a aprobada o regular ("7 de cada 10") y cuántas materias habilita al aprobarse. Los intentos y si se puede rendir libre no se publican: la reseña de hoy no captura cuántas veces se cursó (queda en Falta decidir).
...
4. **"¿Es la materia o es una cátedra?"**: la dispersión entre las cátedras que la dictan, para lo que varía fuerte entre ellas ("las clases perdidas son de una cátedra: Pérez, con 56 %, contra 14 % y 7 % de las otras dos"). Lo que no varía entre cátedras se dice aparte, como propio de la materia.
5. **Cómo termina la cursada**: la tasa de finalización agregada de la materia.
6. **Con qué se llevó**: los pares de materias cursadas juntas y cómo les fue ([US-143](../../stories/US-143-check-which-subjects-to-take-together/README.md)).
7. **A la derecha** (en pantalla ancha; debajo, en celular): las otras materias del mismo año del plan, con link a su ficha.
8. **Pie**: "¿Cómo calculamos esto?" (a Método), "Bajar los datos" (el CSV) y el llamado a reseñar.
