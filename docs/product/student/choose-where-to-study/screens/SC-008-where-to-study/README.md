...
- **Encabezado**: la carrera canónica que se compara (la decide el catálogo, no el parecido del nombre: "Ingeniería en Sistemas" puede agrupar una oferta llamada distinto en otra institución) y cuántas instituciones la dictan en esa aglomeración (localidades que el equipo declara como un mismo continuo urbano, ej. Gran San Miguel de Tucumán).
