...
1. **Identidad**: la materia, la cátedra, la institución y la carrera con links a sus fichas; y la línea de sustento: "16 reseñas, de 2024 a 2026 · lo último es de hoy" (dispersión temporal, [ADR-0083](../../../../../decisions/0083-the-ficha-publishes-counts-not-scores.md)). "Voces" aparece solo como denominador al pie de cada frase ("de 14 voces").
...
3. **Cómo termina la cursada acá**: la tasa de finalización agregada ("de cada 10 que la cursan, llegan 4"), como barra de dos tramos, comparada contra las cátedras hermanas de la misma materia cuando la diferencia es real ("en González llegan 9 de cada 10; en Ruiz, 7"). Ninguna reseña muestra cómo terminó nadie: esto es el conteo. "Las hermanas" (la comparación con las otras cátedras de la materia) va en la columna derecha en pantalla ancha, debajo en celular.
