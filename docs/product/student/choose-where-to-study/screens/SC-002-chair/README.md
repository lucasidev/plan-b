...
> Ficha de pantalla ([formato](README.md)). **Estado**: **describe el modelo anterior a [ADR-0078](../../../../../decisions/0078-the-questionnaire-collects-in-pairs-the-ficha-reports-by-theme.md)** (cabecera dual y listas por eje, superados: la ficha informa por tema y la atribución viaja en cada hecho); su reescritura es la spec de la ficha, planificada aparte de R1. **La versión mínima de R1 (issue #360) está definida y bocetada en [sketch.html](sketch.html)** (2026-08-24, rehecha el mismo día tras revisión en sesión): la ficha muestra **inteligencia sobre lo recolectado**, nunca la lista de lo que respondieron: la prevalencia por tema en las dos direcciones (ADR-0078, ADR-0080), el retrato (los hechos más sostenidos, top-k mecánico por frecuencia encogida, del signo que salgan), la serie por período, y el estado sin voces; el detalle hecho por hecho es dato del Método y del CSV, no cara de la ficha. El boceto anterior quedó en git. Hasta la spec completa, leer los mecanismos (voces, encogimiento, testimonios, réplica) como vigentes y la organización visual del cuerpo de esta ficha como caduca. Revisada el 2026-08-19 ([registro](../../../../../history/reviews/2026-08-19-epics-and-screens.md)); el boceto es [`sketch.html`](sketch.html), **hi-fi en la dirección Boletín** ([ADR-0071](../../../../../decisions/0071-the-visual-language-is-a-bulletin.md), aprobado el 2026-08-19; el mid-fi quedó en git). Pantalla pública, se lee sin cuenta. Slug propuesto: `/chairs/[id]` (hoy el chasis es `/teachers/[id]`, la ficha del docente; la cátedra como entidad es US-196). Épicas que la componen: [Elegir dónde estudiar](../../README.md) (la lectura, los testimonios, de cuándo son), [Reseñar](../../../write-a-review/README.md) (llega desde acá y vuelve), [Cuidar lo publicado](../../../care-for-what-is-published/README.md) (votar, corregir), [Deshacer](../../../undo/README.md) (reportar) y [Replicar](../../../../reviewed/reply/README.md) (la réplica al lado, el estado del canal).
