...
2. **Los hechos que la marcan**: la fama por convergencia. Cuando varios ítems distintos apuntan al mismo lado, la ficha lo dice arriba, como predicado del sujeto ("Acá no se aprende preguntando"), con el sustento como metadato ("el 63 % casi nunca salía entendiendo, el 66 % no podía preguntar sin quedar mal, y al 59 % casi nunca le contestaban en clase"). Tres ítems convergentes valen más que quinientas marcas en uno.
...
4. **Qué hizo la cátedra**, con sus voces: cada ítem de conducta observable ("¿Contestaba las preguntas en clase?", "¿Se dictaron las clases?", "¿El práctico daba lo mismo que el teórico?", y el resto del catálogo) con su moda como badge ("Casi nunca · 59 %"), su distribución completa por opción como barra segmentada (rojo solo en la opción negativa) y el conteo crudo de cada opción con su "de N".
5. **Qué les pasó a los que cursaron**, con sus voces: los ítems de vivencia ("¿Salías de la clase entendiendo?", "¿El material alcanzaba para el parcial?", "¿Pudiste seguir el ritmo?", "¿Podías preguntar sin quedar mal?"), con el mismo formato de moda y distribución. Este bloque y el anterior no se suman entre sí ([ADR-0083](../../../../../decisions/0083-the-ficha-publishes-counts-not-scores.md)).
...
- **Cuántos hechos entran en "los hechos que la marcan"** antes de "ver todos", y qué pasa si ningún ítem converge todavía.
- **Cuántos ítems por bloque entran antes de "ver todos"** en "qué hizo la cátedra" y "qué les pasó a los que cursaron".
...
- **Lo que necesita del sistema para existir**: la cátedra como entidad (US-196); los conteos por ítem, opción y período de las cursadas de la cátedra; el piso (ADR-0082) y la comparación con intervalos (ADR-0083); la respuesta firmada con su verificación (Responder).
