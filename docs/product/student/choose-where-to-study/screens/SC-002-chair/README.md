...
1. **Identidad**: el eyebrow con la materia y quién está a cargo ("Cátedra · 211 · Fundamentos de Control de Calidad · a cargo de Martín Pérez"), el nombre de la cátedra y la línea de sustento: "16 reseñas de 2024 a 2026 · lo último es de hoy" (dispersión temporal, [ADR-0083](../../../../../decisions/0083-the-ficha-publishes-counts-not-scores.md)). La universidad, la carrera, la materia y la cátedra van en las migas del topbar, con link a sus fichas. Mientras las reseñas contadas sean del corpus de demostración, debajo va el aviso "Estas reseñas son de prueba. Las cargamos nosotros para mostrar cómo funciona la ficha: todavía no hay reseñas reales." Después, la tira de números: cuántos llegan al final, reseñas, frases que convergen y contrastes con las hermanas. "Voces" aparece solo como denominador al pie de cada frase ("de 14 voces", "de 1 voz").
...
6. **Comparada con las otras cátedras de la materia**: las frases donde esta cátedra se separa de sus hermanas y la diferencia sobrevive a la regla de los intervalos, con los dos porcentajes y sus voces ("Faltaron muchas: 56 % acá, 11 % en las otras · de 16 y 18 voces").
7. **Qué respondió la cátedra**: la respuesta firmada, con nombre y cargo, a los números agregados de esta ficha (no a un testimonio puntual: no existe uno publicado, [ADR-0084](../../../../../decisions/0084-free-text-feeds-curation-and-is-never-published.md)); mientras no llega, "Sin respuesta" con la fecha en que se avisó.
8. **Pie**: "¿Cómo calculamos esto?" (a Método), "Bajar los datos" (el CSV) y el llamado a reseñar (a Reseñar, con cuenta).
9. **A la derecha** (en pantalla ancha; debajo, en celular): "Las hermanas · misma materia", las otras cátedras de la materia que juntan reseñas, cada una con su conteo y link a su ficha.
...
- **Sin base para comparar**: ninguna hermana de la materia publica todavía; "Comparada con las otras cátedras" lo dice: "Sin base comparable todavía: ninguna hermana llega a las 10 reseñas."
- **Hermanas publicadas, sin diferencia que se sostenga**: la sección "Comparada con las otras cátedras" no aparece.
- **Sin respuesta**: el bloque 7 declara el estado del canal ("Sin respuesta", con la fecha en que se avisó), nunca "no quiso responder".
