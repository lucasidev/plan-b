...
4. **Carreras**: primero las que se dictan en más de una institución, una fila por carrera canónica con sus instituciones en nombre corto, "con reseñas" cuando alguna de sus ofertas junta reseñas y cuántas instituciones la dictan; la fila entera lleva a [Dónde estudiarla](../SC-008-where-to-study/README.md), donde se comparan lado a lado. Después, las que se dictan en una sola institución, en lista compacta. Primero las que tienen reseñas, después las que dictan más instituciones y, a igual cantidad, alfabético; nunca un orden por conveniencia (US-171).
