...
3. **Lo que los datos dicen**, a la derecha de la lente Universidades: cinco líneas calculadas solo con datos oficiales y conteos del catálogo, cada una con su fuente y su período, y quien no informa nombrado con la nota del hecho: la universidad más elegida (estudiantes, anuario SPU), la carrera más ofrecida (en cuántas instituciones se dicta la misma carrera canónica), la carrera con mejor tiempo de salida (egreso por cohorte, dicho como el derivado de la institución entera que es, con el link a su regla en Método), la universidad donde más alumnos avanzan (reinscriptos con dos o más materias aprobadas) y la evaluación de la entidad auditora (hoy, la única con evaluación institucional de CONEAU publicada). Un empate se muestra como empate, con las empatadas iguales; nunca un ranking completo ni un número compuesto ([ADR-0096](../../../../../decisions/0096-explorar-interprets-official-data-by-institution-and-career.md)).
...
- **La evaluación de la entidad auditora cuando haya más de una**: hoy solo UNT tiene evaluación institucional de CONEAU relevada, y la línea dice eso; con más de una, se listan sin declarar una "mejor", porque la evaluación es un informe y no un puntaje.
