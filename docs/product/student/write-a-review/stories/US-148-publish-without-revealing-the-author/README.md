...
- Ninguna reseña se publica individual: lo que se publica es el agregado por cátedra (la moda y la distribución de cada pregunta, con sus voces), y recién desde que la cátedra junta 10 reseñas ([ADR-0082](../../../../../decisions/0082-the-review-captures-the-cursada-in-three-layers.md), [ADR-0083](../../../../../decisions/0083-the-ficha-publishes-counts-not-scores.md)).
