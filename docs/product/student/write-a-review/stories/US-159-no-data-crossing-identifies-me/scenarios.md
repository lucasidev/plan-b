...
Entonces se publican los conteos por pregunta (moda, distribución, voces), pero ninguna columna ni campo trae un nombre, una cuenta ni un identificador de perfil.
