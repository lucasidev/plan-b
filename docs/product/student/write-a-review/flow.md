...
flowchart TD
  ...
  D --> E[Paso 4 · Qué hizo la cátedra: siete preguntas, frecuencias gruesas]
  E --> F[Paso 5 · Qué te pasó a vos: cuatro preguntas, vivencia]
  F --> H[Paso 6 · Lo último: campo libre que no se publica, ADR-0084]
  H --> I[Enviar la reseña]
  I --> K([Publicada: suma voz a sus preguntas<br/>el contrato ya se dijo antes de enviar, US-148, US-159])
  ...
  F -.-> R
  R -.-> B
  K --> L[Mis aportes: qué sumó cada pregunta que respondiste, US-162]
```
...
- [Mis aportes](../undo/screens/SC-018-my-contributions/README.md): a donde vuelve la reseña publicada, con lo que sumó cada pregunta (nodo L).
...
El orden y el colapso por defecto de las preguntas dentro de los pasos 4 y 5, si el catálogo crece; si el selector de cátedra del paso 2 acepta texto libre además de la lista del catálogo; si el copy "en un grupo chico pueden sospechar" se dice en algún lado además del estado del piso mostrado en el paso 6; qué muestra Mis aportes al terminar.
