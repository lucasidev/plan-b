...
- **Si una cursada sin cátedra recordada pierde las preguntas de cátedra o hace falta una «cátedra sin identificar»**: hoy el boceto ofrece "No me acuerdo" y quita esas preguntas.
...
- **Qué hace la curaduría con un campo libre que identifica a un tercero** (un alumno, no un docente): sigue sin publicarse nunca, pero si necesita algún tratamiento especial antes de destilarse en pregunta es decisión del equipo de curaduría, no de esta épica.
- **El orden y el colapso por defecto de las preguntas de los pasos 4 y 5** si el catálogo crece: el boceto de R1 las muestra todas abiertas.
