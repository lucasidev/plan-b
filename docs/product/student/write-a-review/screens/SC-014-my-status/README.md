...
La pregunta de trayectoria de a uno: ¿seguís cursando la carrera? Sigo / me recibí, en… / me fui, en… / ahora no. Es una sola pregunta con un año, y se contesta una sola vez: respondida, se apaga para siempre (US-169). Esto no es una pregunta del catálogo de la cursada ([`phrases.md`](../../../../phrases.md)): es un hecho aparte, de a uno, nunca como inventario. Sin esto no sabemos dónde se cae la mayoría ni cuánto tarda la gente de verdad, y el silencio no se infiere.
