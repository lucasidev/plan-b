...
**Ana** (para saber si tiene alguna chance: cuánta gente más pidió lo mismo), **Rocío** (qué carreras están en cola, parte de lo que declara antes de citar un número). Del otro lado, **Sofía** carga por esta misma cola ([Sostener el catálogo](../../../../team/sustain-the-catalog/README.md)). El flujo entero: [`flow.md`](../../flow.md).
