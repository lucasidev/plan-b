...
flowchart TD
  ...
  B -->|edita una respuesta| B1[Se actualiza esa respuesta:<br/>los conteos de la pregunta se recalculan, US-165]
...
- **Respuesta editada**: se actualiza al instante, sin ningún chequeo; los conteos de la pregunta se recalculan hacia atrás.
