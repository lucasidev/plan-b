...
3. **Tu carrera.** El plan de la carrera declarada, por año, cada materia con lo que junta ("3 cátedras · 28 reseñas" o "sin reseñas") y link a su ficha. Es el mismo plan que la ficha de la carrera, mirado desde la cuenta.
...
Nada. El orden de la lista es por la cursada más reciente, el que Inicio cerró el 2026-08-31: la story pregunta qué pasó con lo que dijiste, y lo reciente es el orden en que la persona lo tiene en la cabeza.
