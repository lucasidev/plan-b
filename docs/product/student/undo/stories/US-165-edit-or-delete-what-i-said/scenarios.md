...
**E1.** Dado que Matías reseñó Análisis Matemático II, Cátedra Pérez, UNSTA, 1C 2025, respondiendo "Faltaron muchas" en "¿Se dictaron las clases?" (pregunta I07), que hoy suma 12 de 40 voces.
...
**N3.** Dado que Matías tiene un aporte publicado con "Faltaron muchas" respondido en "¿Se dictaron las clases?" (pregunta I07).
Cuando entra a Editar y vuelve esa respuesta a sin responder (la saltea), sin tocar el resto de la reseña.
Entonces I07 deja de contar la voz de Matías (pasa a 11 de 39 para esa pregunta), mientras el resto de sus respuestas sigue contando sobre 40: saltear después de haber respondido también vale.
