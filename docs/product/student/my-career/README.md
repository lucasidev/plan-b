...
| ID | De qué trata |
|---|---|
| [US-143](stories/US-143-check-which-subjects-to-take-together/README.md) | Ver qué materias se pueden cursar juntas |
| [US-144](stories/US-144-filter-pairings-by-my-own-plan/README.md) | Filtrar esas combinaciones contra lo que todavía falta cursar |
| [US-145](stories/US-145-plan-on-paper-mark-it-yourself/README.md) | Armar el cuatrimestre en papel, sin planificador propio |
