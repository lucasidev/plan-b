...
| ID | De qué trata |
|---|---|
| [US-168](stories/US-168-read-without-an-account.md) | Leer sin necesitar cuenta |
| [US-169](stories/US-169-never-asked-twice.md) | No repetir lo que ya dije |
...
Esta épica no tiene pantallas propias: es la garantía que se verifica en cada pantalla de las demás. Las que cita para verificarse viven en sus épicas dueñas: todas las públicas del [mapa](../map.md) (US-168, US-171), [Reseñar](../write-a-review/README.md) y [Empezar](../my-career/README.md) (US-169, US-170), [**Ingresar**](../enter/screens/SC-025-sign-in/README.md), [**Registro**](../enter/screens/SC-026-sign-up/README.md) y [**Recuperar**](../enter/screens/SC-024-forgot-password/README.md) (el umbral: el gate en la acción, vuelta a donde ibas).
...
La [Ficha de cátedra](../choose-where-to-study/screens/SC-002-chair/README.md) ya las responde: se lee sin cuenta, no repite ninguna pregunta, no depende de ningún plan marcado y ordena por votos, nunca por conveniencia. Las fichas escritas el 2026-08-19 tienen esta verificación pendiente: es parte de su revisión adversarial.
