...
### 1 · Hechos con voces, leídos por tema

Lo que se publica es el hecho vivido con cuántas voces lo sostienen: "hay clases que no se dan: 37% de 120 personas". Cada hecho es su propio dato, con su propio denominador, y no se promedia con ningún otro: un puntaje promediaría nueve fallas distintas y escondería ocho, y el hecho dice cuál. El encogimiento por pocas voces tiene nombre y fórmula publicada (el límite inferior de Wilson): cuatro marcas de cuatro no producen un 100%. Por qué hechos y no un 1 a 5, con las alternativas y las fuentes: [ADR-0064](decisions/0064-phrases-with-voices-not-scores.md).

La ficha los informa por **tema**, las partes de la vivencia (la enseñanza, la evaluación, el trato, los trámites): dentro de cada tema, sus hechos con sus voces y una prevalencia con fórmula publicada para leer en dos segundos. Recolectar e informar son dos capas: el cuestionario ofrece vocabulario para lo vivido, la ficha calcula sobre lo marcado, y ninguna decisión de una condiciona a la otra. Por qué el tema organiza el reporte y qué quedó descartado (el índice ponderado, el promedio, el resumen por eje): [ADR-0078](decisions/0078-the-questionnaire-collects-in-pairs-the-ficha-reports-by-theme.md).

### 2 · Atribución: la decide el eje

La pregunta de quien elige es si lo que la hace difícil es la carrera o la facultad, porque una cosa la elige y la otra la sufre. Una carrera exigente no es una carrera mal llevada, y confundirlas es exactamente lo que protege al que la lleva mal. Cada frase del catálogo carga esa respuesta escrita en su redacción, su **eje**: lo de **exigencia** es la carrera siendo dura, venga de la materia, de la cátedra o de quien sea (información, no defecto); lo de **gestión** es alguien fallando (alarma). El **sujeto** de la frase (materia, cátedra o institución: las fichas reales; el mostrador y el centro de estudiantes son temas de la vivencia institucional) no atribuye: dice a qué ficha va y, cuando es cátedra o institución, quién. La atribución no se declara ni se pregunta: está en el catálogo, en la redacción y el eje de cada frase, publicado entero en el método.

La atribución viaja en cada hecho publicado, y en ningún otro lado: no existe un resumen de atribución. Un split del tipo "el 65% de lo difícil es la institución" mediría cuántas frases ofrecemos por eje, no lo que la gente dijo, y escondería que una materia puede ser dura y estar mal llevada a la vez. Por qué así, con las alternativas: [ADR-0065](decisions/0065-attribution-is-the-axis-not-a-split.md).
...
1. **La reseña de una cursada.** El acto principal: elegís una materia que cursaste. Lleva la materia y el período en que la cursaste; **cómo terminó** (la aprobaste, te quedó regular, la desaprobaste, la dejaste, seguís); la cátedra, si la recordás; las **frases que marcás** de las que se ofrecen (las nuestras y las ya destiladas para esa materia); el **comentario** en tus palabras, opcional; y si hubo clases que no se dieron, cuántas (una pregunta que aparece solo si marcaste que sí). Cada frase habla de algo (su **sujeto**: la materia, la cátedra o la institución, que son las fichas donde aterriza el dato), nombra una parte de la vivencia (su **tema**: la evaluación, el trato, los costos) y carga su atribución escrita (su **eje**: exigencia o gestión). Todo lo que hace a la cursada entra acá: cómo se dicta, cómo se evalúa, el 10 que nunca ponen, rendir libre, el trato, y también el acoso, como cualquier otra frase.
...
1. **La unidad de publicación es la frase con su proporción de voces**, informada dentro de su tema. Cada frase es su propio hecho, con su propio n; no se promedia con ninguna otra. La única cantidad que no es una frase, cuántas clases no se dieron, se publica como mediana y rango con sus voces, por período, sin piso.
2. **No hay número global 1 a 5.** Ni total, ni por tema, ni por eje. La ficha informa por tema: sus frases con voces y una prevalencia (cuántas personas marcaron al menos un hecho del tema, en cada dirección) que nunca es un promedio de frases y lleva su fórmula en el método ([ADR-0078](decisions/0078-the-questionnaire-collects-in-pairs-the-ficha-reports-by-theme.md)).
...
6. **La atribución la decide el eje** ([ADR-0065](decisions/0065-attribution-is-the-axis-not-a-split.md)): exigencia es la carrera siendo dura, gestión es alguien fallando, venga del sujeto que venga. Viaja escrita en cada hecho publicado; nunca como un split de marcas ni como un resumen propio. El catálogo de frases con su sujeto, su tema y su eje se publica entero en el método.
...
8. **Todo dato derivado viaja con su cobertura** (cuántas materias canónicas de la carrera tienen voces, sobre todos sus planes) y cada frase derivada dice en cuántas materias aparece: lo sistémico y lo local se distinguen con un número. **La derivación de carrera e institución espera** a que más de la mitad de las materias canónicas de la carrera tenga voces; hasta entonces la ficha dice que todavía no derivamos y se lee materia por materia.
9. **No hay piso.** Todo se publica desde la primera voz, como "X de N voces" y con su encogimiento a la vista; nada se desbloquea por escalones. Vale para las frases, las prevalencias, los derivados, los cruces y el CSV.
...
11. **La serie es por el período en que pasó**, no por cuándo se reseñó; cada punto con sus voces y su encogimiento, sin suavizar, con la fecha de publicación y la de la réplica marcadas. Cuando el vocabulario de un tema cambia, su serie de prevalencia **declara la ruptura**: el corte se marca, los tramos no se comparan a través, y el período del cambio se parte en antes y después ([ADR-0080](decisions/0080-numbers-publish-without-floor-and-series-declare-their-breaks.md)).
12. **Comparar es lado a lado, dato por dato, sin ordenar por valor.** La misma carrera (una carrera canónica que cura el catálogo) en varias instituciones: nominal, real, brecha, egreso, las prevalencias por tema con su gate, la cobertura, las frases con sus voces. Sin compuesto y sin ganador; el que quiere ordenar baja el CSV, que gana una segunda tabla con los agregados de trayectoria.
