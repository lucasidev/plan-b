...
Los dos salen de conteos de frases, con encogimiento hacia el medio según cuánta gente habló: cuatro toques de un solo lado no producen un 5.0.
...
- **No juzga lo que mide.** Publicamos el número, no el veredicto.
