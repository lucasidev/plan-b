...
11. **El instrumento se versiona y la serie declara sus cortes**: si una frase cambia de significado, cambia de código y la serie no se compara a través. La lista se reprocesa a medida que entran reseñas, y se dice. Y la ficha dice la tendencia con palabras: si la cátedra mejoró, empeoró o sigue igual respecto del período anterior.
12. **El método entero es público**, con el catálogo de frases, las reglas de publicación y el piso; y los datos se bajan como se publican, agregados: no existe un crudo que tenga más que la ficha. Por carrera o por institución hay una hoja para llevar: los conteos con sus voces y sus fuentes, para una reunión.
